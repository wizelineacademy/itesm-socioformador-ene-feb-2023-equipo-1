...
function UserControls(props) {
  ...
  return /* @__PURE__ */ import_react20.default.createElement(NavBar, {
    ...
    id: "dashboard"
  }, "Dashboard")), /* @__PURE__ */ import_react20.default.createElement(NavLi, null, /* @__PURE__ */ import_react20.default.createElement(import_react_bootstrap4.ButtonToolbar, null, /* @__PURE__ */ import_react20.default.createElement(UserDropdown, {
    name,
    title,
    email,
    picture,
...
// app/controllers/answerBot/pythonUrl.js
init_react();
var FLASK_ENDPOINT = "3.213.188.151";

// app/controllers/answerBot/pdfConv.js
var endpoint = `http://${FLASK_ENDPOINT}:4000/api/pdf_conversation_gpt`, pdfConv = async (conversation) => fetch(`http://${FLASK_ENDPOINT}:4000/api/pdf_conversation_gpt`, {
  method: "POST",
  ...
  throw console.log(endpoint), new Error(`There was an error making the API call: ${error.message}`);
}), updateAnswers = async () => fetch(`http://${FLASK_ENDPOINT}:4000/api/updateAnswers`).catch((error) => {
  throw new Error(`There was an error making the API call: ${error.message}`);
}), uploadFiles = async (formData) => fetch(`http://${FLASK_ENDPOINT}:4000/api/uploadFile`, {
  method: "POST",
  body: formData
}).catch((error) => {
  throw new Error(`There was an error making the API call: ${error.message}`);
...
function AnswerBot({
  ...
  let instructions = INSTRUCTIONS_ANSWERBOT, [messages, setMessages] = (0, import_react78.useState)([{ role: "system", content: instructions }, { role: "system", content: WELCOME_MESSAGE }]), [messagesID, setMessagesID] = (0, import_react78.useState)([{ role: "system", content: instructions, depa: null }, { role: "system", content: WELCOME_MESSAGE, depa: null }]), messagesEndRef = (0, import_react78.useRef)(null), [inputValue, setInputValue] = (0, import_react78.useState)(""), [isWaitingForResponse, setIsWaitingForResponse] = (0, import_react78.useState)(!1), handleInput = async (e) => {
    ...
    if (message.length > 13) {
      ...
      let filteredMessages = [...messages, { role: "user", content: message }].filter((mess, index2) => index2 !== 1), response = await pdfConv(filteredMessages), answer = response.text;
  ...
  return (0, import_react78.useEffect)(() => {
    ...
    id: `internal-msg-${index2}`,
    key: `message-${message.id}`,
    className: "user",
    ref: messagesEndRef,
    isWaiting: !1
  }, /* @__PURE__ */ import_react78.default.createElement("span", null, message.content)), /* @__PURE__ */ import_react78.default.createElement(IconUser, {
    id: `icon-user-${index2}`,
  ...
  }, /* @__PURE__ */ import_react78.default.createElement("span", null, message.content))), index2 !== 0 && /* @__PURE__ */ import_react78.default.createElement("div", null, !showThanksMessage[index2] && (index2 !== messages.length - 2 || !isWaitingForResponse) && /* @__PURE__ */ import_react78.default.createElement(import_react78.default.Fragment, null, /* @__PURE__ */ import_react78.default.createElement(LikeButton, {
    id: `like-${index2}`,
    key: `like-${message.id}`,
...
function FAQs({ questionsFAQ }) {
  return /* @__PURE__ */ import_react80.default.createElement(FAQContainer, {
    id: "FAQContainer"
  }, /* @__PURE__ */ import_react80.default.createElement(FAQHeader, null, "FAQ's"), questionsFAQ.map((faq) => /* @__PURE__ */ import_react80.default.createElement(FAQList, {
    id: "FAQList"
  }, /* @__PURE__ */ import_react80.default.createElement(Question, {
    id: "Question",
...
function SideBar({ departments, selectedDepartment, handleSelectDepartment }) {
  return /* @__PURE__ */ import_react83.default.createElement(MainContainer2, null, /* @__PURE__ */ import_react83.default.createElement(DepContainer, null, /* @__PURE__ */ import_react83.default.createElement(TitleDep, null, "Departaments"), /* @__PURE__ */ import_react83.default.createElement(ListDep, null, departments.map((item, index2) => /* @__PURE__ */ import_react83.default.createElement(DepSelect, {
    id: `dep-${index2}`,
    key: item.name,
...
function Dashboard() {
  let {
    ...
    questionsBot,
    departments
  } = (0, import_react85.useLoaderData)(), [searchParams, setSearchParams] = (0, import_react85.useSearchParams)(), [selectedDepartment, setSelectedDepartment] = (0, import_react84.useState)(departments[0].department_id);
  return /* @__PURE__ */ import_react84.default.createElement(import_react84.default.Fragment, null, /* @__PURE__ */ import_react84.default.createElement(AdminSideBar_default, {
  ...
  }), /* @__PURE__ */ import_react84.default.createElement(MainContainer, null, /* @__PURE__ */ import_react84.default.createElement(NextContainer, null, /* @__PURE__ */ import_react84.default.createElement(DividerContainer, null, /* @__PURE__ */ import_react84.default.createElement(TopContainers, {
    id: "openForums"
  }, /* @__PURE__ */ import_react84.default.createElement(ContMargin, null, /* @__PURE__ */ import_react84.default.createElement(Title, null, "Open Forums"), /* @__PURE__ */ import_react84.default.createElement(import_react_bootstrap11.Table, {
    hover: !0
  }, /* @__PURE__ */ import_react84.default.createElement("tbody", null, questionsOF.map((question, index2) => /* @__PURE__ */ import_react84.default.createElement("tr", null, /* @__PURE__ */ import_react84.default.createElement(Text, {
    ...
    key: question.id,
    title: question.question
  }, "Answer it \u2192")))))))), /* @__PURE__ */ import_react84.default.createElement(TopContainers, {
    id: "answerbotF"
  }, /* @__PURE__ */ import_react84.default.createElement(ContMargin, null, /* @__PURE__ */ import_react84.default.createElement(Title, null, "Answerbot Feedback"), /* @__PURE__ */ import_react84.default.createElement(import_react_bootstrap11.Table, {
    stripped: !0,
    hover: !0
    ...
    key: `feedbackAB-${question.id}`
  }, /* @__PURE__ */ import_react84.default.createElement(TextABorder, null, " Good "))))))))), /* @__PURE__ */ import_react84.default.createElement(BottomContainer, {
    id: "FAQs"
  }, /* @__PURE__ */ import_react84.default.createElement(ContMargin, null, /* @__PURE__ */ import_react84.default.createElement(Title, null, "FAQs"), /* @__PURE__ */ import_react84.default.createElement(import_react_bootstrap11.Table, {
    stripped: !0,
    hover: !0
  }, /* @__PURE__ */ import_react84.default.createElement("thead", null, /* @__PURE__ */ import_react84.default.createElement("tr", null, /* @__PURE__ */ import_react84.default.createElement(TextBold, {
    width: "330"
    ...
    return /* @__PURE__ */ import_react84.default.createElement("tr", null, /* @__PURE__ */ import_react84.default.createElement(Text, {
      ...
      key: `statusFAQ-${question.id}`
    }, /* @__PURE__ */ import_react84.default.createElement(TextBBorder, null, " Answered by Community ")), question.Answers.length <= 0 && (question.Comments.length === 0 || question.Comments.every((comment) => comment.approvedBy === null) && question.Comments.some((comment) => comment.CommentVote.length === 0 || comment.CommentVote.length > 0 && comment.CommentVote.every((vote) => vote.value < 10))) && /* @__PURE__ */ import_react84.default.createElement(TextU, {
      key: `statusFAQ-${question.id}`
...
init_react();
var import_react101 = require("@remix-run/react"), import_styled_components57 = __toESM(require("styled-components")), Container9 = import_styled_components57.default.div`
  display: flex;
  background-color: #f4f7f9;
  margin: 0 auto;
  width: 100%;
...
function GoToTopButton() {
  ...
  }, []), /* @__PURE__ */ import_react104.default.createElement(Button3, {
    id: "go-to-top-button",
    display: show,
    onClick: () => {
      window.scrollTo({
...
init_react();
var assets_manifest_default = { version: "56ea6222", entry: { module: "/build/entry.client-HGI6S5C2.js", imports: ["/build/_shared/chunk-AOIRIE2A.js", "/build/_shared/chunk-NQOTFIF5.js", "/build/_shared/chunk-3WZ3CGWF.js"] }, routes: { root: { id: "root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/root-TKPHIKIW.js", imports: ["/build/_shared/chunk-NPNCWMXA.js", "/build/_shared/chunk-CHRNTAPK.js", "/build/_shared/chunk-KHI65GMO.js", "/build/_shared/chunk-6TCZEOTC.js", "/build/_shared/chunk-TIDFRYFE.js", "/build/_shared/chunk-PATUF2VW.js", "/build/_shared/chunk-CXIA25NB.js", "/build/_shared/chunk-XLYT5D5E.js", "/build/_shared/chunk-MTRSEIQJ.js", "/build/_shared/chunk-YT3K4J47.js", "/build/_shared/chunk-CLYBQCO7.js", "/build/_shared/chunk-2FVL2P6G.js", "/build/_shared/chunk-DTXDYIFC.js", "/build/_shared/chunk-UPCFJQSK.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !0 }, "routes/$": { id: "routes/$", parentId: "root", path: "*", index: void 0, caseSensitive: void 0, module: "/build/routes/$-J7SF2NML.js", imports: ["/build/_shared/chunk-5GQEKSSL.js"], hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/about": { id: "routes/about", parentId: "root", path: "about", index: void 0, caseSensitive: void 0, module: "/build/routes/about-FKIM2JZ5.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/admin": { id: "routes/admin", parentId: "root", path: "admin", index: void 0, caseSensitive: void 0, module: "/build/routes/admin-UJKD6KT3.js", imports: ["/build/_shared/chunk-5GQEKSSL.js", "/build/_shared/chunk-35OB2BUG.js", "/build/_shared/chunk-FKO5MXVG.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !0, hasErrorBoundary: !1 }, "routes/auth/auth0": { id: "routes/auth/auth0", parentId: "root", path: "auth/auth0", index: void 0, caseSensitive: void 0, module: "/build/routes/auth/auth0-ITMSNXEC.js", imports: void 0, hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/auth/auth0/callback": { id: "routes/auth/auth0/callback", parentId: "routes/auth/auth0", path: "callback", index: void 0, caseSensitive: void 0, module: "/build/routes/auth/auth0/callback-4TNALWYI.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/contact": { id: "routes/contact", parentId: "root", path: "contact", index: void 0, caseSensitive: void 0, module: "/build/routes/contact-IY7FPXLE.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/dashboard": { id: "routes/dashboard", parentId: "root", path: "dashboard", index: void 0, caseSensitive: void 0, module: "/build/routes/dashboard-SOR3CFKA.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/employees/getByDeparment/$id": { id: "routes/employees/getByDeparment/$id", parentId: "root", path: "employees/getByDeparment/:id", index: void 0, caseSensitive: void 0, module: "/build/routes/employees/getByDeparment/$id-I7VIXFAC.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/index": { id: "routes/index", parentId: "root", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/index-XKCQHVXY.js", imports: ["/build/_shared/chunk-PNOSEPO2.js", "/build/_shared/chunk-OEMRJMFZ.js", "/build/_shared/chunk-MVDRZQQY.js", "/build/_shared/chunk-LKOJQBOU.js", "/build/_shared/chunk-DMHBAV2X.js", "/build/_shared/chunk-FKO5MXVG.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/login": { id: "routes/login", parentId: "root", path: "login", index: void 0, caseSensitive: void 0, module: "/build/routes/login-DU4OROKL.js", imports: ["/build/_shared/chunk-PNOSEPO2.js", "/build/_shared/chunk-LKOJQBOU.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/logout": { id: "routes/logout", parentId: "root", path: "logout", index: void 0, caseSensitive: void 0, module: "/build/routes/logout-XHWZMWF6.js", imports: void 0, hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/questions/$questionId": { id: "routes/questions/$questionId", parentId: "root", path: "questions/:questionId", index: void 0, caseSensitive: void 0, module: "/build/routes/questions/$questionId-ZFOHYDV6.js", imports: ["/build/_shared/chunk-35OB2BUG.js", "/build/_shared/chunk-OEMRJMFZ.js", "/build/_shared/chunk-DQMYHA6A.js", "/build/_shared/chunk-DMHBAV2X.js", "/build/_shared/chunk-FKO5MXVG.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/questions/new": { id: "routes/questions/new", parentId: "root", path: "questions/new", index: void 0, caseSensitive: void 0, module: "/build/routes/questions/new-OFNJC6DA.js", imports: ["/build/_shared/chunk-MVDRZQQY.js", "/build/_shared/chunk-LKOJQBOU.js", "/build/_shared/chunk-DQMYHA6A.js", "/build/_shared/chunk-DMHBAV2X.js", "/build/_shared/chunk-FKO5MXVG.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 } }, url: "/build/manifest-56EA6222.js" };
