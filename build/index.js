...
`, TextBBorder = import_styled_components46.default.span`
  ...
  padding-right: 10px;
  padding-left: 10px;
`, TextC = import_styled_components46.default.td`
 color: #DE9A34;
 font-weight: 400;
 letter-spacing: 1px;
`, TextCBorder = import_styled_components46.default.span`
  display: inline-block;
...
function Dashboard() {
  ...
  return /* @__PURE__ */ import_react84.default.createElement(import_react84.default.Fragment, null, /* @__PURE__ */ import_react84.default.createElement(AdminSideBar_default, {
    ...
    }, /* @__PURE__ */ import_react84.default.createElement(TextABorder, null, " Answered ")), question.Answers.length <= 0 && question.Comments.every((comment) => comment.approvedBy === null) && question.Comments.some((comment) => comment.CommentVote.length > 0 && comment.CommentVote.some((vote) => vote.value >= 10)) && /* @__PURE__ */ import_react84.default.createElement(TextC, {
      key: `statusFAQ-${question.id}`
    }, /* @__PURE__ */ import_react84.default.createElement(TextCBorder, null, " Answered by Community ")), question.Answers.length <= 0 && (question.Comments.length === 0 || question.Comments.every((comment) => comment.approvedBy === null) && question.Comments.some((comment) => comment.CommentVote.length > 0 && comment.CommentVote.every((vote) => vote.value < 10))) && /* @__PURE__ */ import_react84.default.createElement(TextU, {
      key: `statusFAQ-${question.id}`
