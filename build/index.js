...
var endpoint = `http://${FLASK_ENDPOINT}:4000/api/pdf_conversation_gpt`, pdfConv = async (conversation) => fetch(endpoint, {
  ...
  throw console.log(FLASK_ENDPOINT), new Error(`There was an error making the API call: ${error.message}`);
