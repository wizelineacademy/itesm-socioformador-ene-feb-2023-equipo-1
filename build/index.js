...
function OpenForumButton() {
  return /* @__PURE__ */ import_react83.default.createElement(Button3, null, /* @__PURE__ */ import_react83.default.createElement(ButtonText, null, "Answer it \u2192"));
}
...
function Dashboard() {
  ...
  }, question.question.length > 100 ? `${question.question.substring(0, 100)}...` : question.question), /* @__PURE__ */ import_react84.default.createElement("td", null, /* @__PURE__ */ import_react84.default.createElement(OpenForumButton_default, null)))))))), /* @__PURE__ */ import_react84.default.createElement(TopContainers, null, /* @__PURE__ */ import_react84.default.createElement(ContMargin, null, /* @__PURE__ */ import_react84.default.createElement(Title, null, "Answerbot Feedback"), /* @__PURE__ */ import_react84.default.createElement(import_react_bootstrap11.Table, {
    stripped: !0,
    hover: !0
...
init_react();
var import_react89 = __toESM(require("react")), import_styled_components50 = __toESM(require("styled-components")), ChatbotContainer2 = import_styled_components50.default.div`
  position: fixed;
  bottom: 0px;
  right: 0px;
  width: 330px;
...
init_react();
var import_styled_components56 = __toESM(require("styled-components")), import_react97 = require("@remix-run/react");
...
// app/styles/NotFound.Styled.jsx
var BackgroundDiv = import_styled_components56.default.div`
    ...
    width: 100%;
    z-index: -1;
`, MainDiv = import_styled_components56.default.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
    height: 60rem;
    margin-top: 3.5rem;
    width: 100%;
`, Container6 = import_styled_components56.default.div`
    align-items: center;
    margin: 0 auto;
    width: 70.4rem;
    display: flex;
...
`, Img = import_styled_components56.default.img`
    display: block;
    height: 12.5rem;
    margin-bottom: 5rem;
    max-width: 100%
`, Title2 = import_styled_components56.default.h2`
    font-size: 4rem;
    font-weight: bold;
    line-height: 1.25;
    text-align: center;
    margin: 0 0 5rem 0;
`, SLink = (0, import_styled_components56.default)(import_react97.Link)`
    color: #fff;
    background-color: var(--color-secondary);
    border-radius: 5px;
    font-size: 1.6rem;
...
init_react();
var import_styled_components57 = __toESM(require("styled-components")), Container7 = import_styled_components57.default.div`
background-color: #f4f7f9;
`;
...
init_react();
var import_react101 = require("@remix-run/react"), import_styled_components58 = __toESM(require("styled-components")), Container8 = import_styled_components58.default.div`
  display: flex;
  background-color: #f4f7f9;
  margin: 0 auto;
  width: 100%;
...
`, LeftWrapper = import_styled_components58.default.div`
  flex: 1;
`, CenterWrapper = import_styled_components58.default.div`
  flex: 2;
  display: flex;
  justify-content: center;
`, RightWrapper2 = import_styled_components58.default.div`
  flex: 1;
  display: flex;
  @media (max-width: 1025px) {
    width: 100%;
...
`, SloganWrapper = import_styled_components58.default.div`
  max-width: 425px;
  
  @media (max-width: 1025px) {
    display: none;
  }
`, QuestionsWrapper = import_styled_components58.default.div`
  max-width: 650px;
  width: 100%;
`, AskQuestionButtonWrapper = import_styled_components58.default.div`
  padding-right: 10px;
  padding-left: 10px;
  flex-direction: row;
  display: flex;
  justify-content: space-between;
  margin-bottom: 20px;
`, QuestionsTitle = import_styled_components58.default.div`
  align-items: center;
  display: flex;
  font-family: "Nunito", sans-serif;
  font-size: 20px;
  letter-spacing: 0.6px;
`, QuestionList = import_styled_components58.default.div`
  margin: 5px 0 10px;
  padding-left: 0;
`, Alert3 = import_styled_components58.default.div`
  border-radius: 3px;
  margin: 0 auto;
  max-width: 592px;
  width: 94%;
...
`, FiltersWrapper = import_styled_components58.default.div`
  width: 100%;
  max-width: 300px;
...
`, AskButton = (0, import_styled_components58.default)(import_react101.Link)`
  align-items: center;
  background: var(--color-secondary);
...
init_react();
var import_styled_components59 = __toESM(require("styled-components")), Button5 = import_styled_components59.default.button`
  all: unset;
  align-items: center;
  background-color: var(--color-secondary);
...
`, Span = import_styled_components59.default.span`
  color: #ffffff;
  font-family: 'Nunito', sans-serif;
  font-size: 14px;
  font-weight: 600;
...
init_react();
var import_styled_components60 = __toESM(require("styled-components")), Filters = import_styled_components60.default.div`
  background-color: transparent;
  margin: 0 11px;
  position: -webkit-sticky;
  position: sticky;
...
`, Icon = import_styled_components60.default.img`
  height: 20px;
  margin-right: 10px;
  width: 17px;
`, FiltersLine = import_styled_components60.default.hr`
  border-top: 1px solid #e6e6e6;
  margin: 16px 0 24px;
  display: ${(props) => props.visibility};
  ${(props) => props.secondary && import_styled_components60.css`
    margin: 0;
  `}
...
`, FiltersWrapper2 = import_styled_components60.default.div`
  flex-grow: 1;
...
`, FiltersContainer = import_styled_components60.default.div`
  display: unset;
`, FiltersBlock = import_styled_components60.default.div``, FiltersLabel = import_styled_components60.default.div`
  font-size: 12px;
  margin: 8px 0 4px;
  width: auto;
  button {
...
`, FiltersField = import_styled_components60.default.div`
  ...
  ${(props) => props.departments && import_styled_components60.css`
...
init_react();
var import_styled_components61 = __toESM(require("styled-components")), import_react_bootstrap13 = require("react-bootstrap"), CDropdown = (0, import_styled_components61.default)(import_react_bootstrap13.Dropdown)`
  .dropdown-menu {
    top: 98%;
    background-color: transparent;
  }
...
`, CDropdownText = import_styled_components61.default.p`
  color: var(--color-secondary);
  float: left;
  font-size: 12px;
  padding-left: 5px;
...
`, CMenuItem = (0, import_styled_components61.default)(import_react_bootstrap13.MenuItem)`
  .custom-dropdown {
    cursor: pointer;
    display: block;
    font-size: 14px;
...
init_react();
var import_styled_components62 = __toESM(require("styled-components")), Modal4 = import_styled_components62.default.div`
    position: fixed;
    top: 0;
    left: 0;
    right: 0;
    ...
    align-items: center;
    background-color: rgba(0, 0, 0, 0.5);
`, ModalDialog4 = import_styled_components62.default.div`
    position: relative;
    border-radius: 5px;
    border: 0;
    background-color: #fff;
...
`, ModalBody5 = import_styled_components62.default.div`
    display: block;
    font-size: 15px;
    background-color: #fff;
    border-bottom: none;
    ...
    box-sizing: border-box;
    text-align: justify;
`, ModalFooter6 = import_styled_components62.default.div`
    border-top: none;
    background-color: #fff;
    border-bottom: none;
    padding: 15px;
...
`, ModalHeader6 = import_styled_components62.default.div`
    overflow-y: hidden;
    padding: 15px;
    box-sizing: border-box;
    display: block;
...
`, ModalTitle5 = import_styled_components62.default.div`
    font-size: 16px;
    font-weight: 600;
    line-height: normal;
    letter-spacing: normal;
    margin-bottom: 8px;
`, ModalSubtitle3 = import_styled_components62.default.div`
    font-size: 16px;
    font-weight: normal;
    letter-spacing: 0.6px;
    line-height: 1.71;
`, ValueText = import_styled_components62.default.span`
    color: ${(props) => props.color};
    font-weight: 600;
    font-size: 16px;
    text-decoration:  ${(props) => props.color} underline overline;
`, ValuesInformation = import_styled_components62.default.div`
...
function Index() {
  let { questions: initialQuestions } = (0, import_react112.useLoaderData)(), [questions, setQuestions] = (0, import_react113.useState)(initialQuestions), fetcher = (0, import_react112.useFetcher)(), [shouldFetch, setShouldFetch] = (0, import_react113.useState)(!0), [page, setPage] = (0, import_react113.useState)(2), [searchParams] = (0, import_react112.useSearchParams)(), onFetchMore = () => {
...
var LoginDiv = import_styled_components63.default.div`
  position: absolute;
  width: 100%;
  height: 100%;
  display: flex;
  ...
  justify-content: center;
  align-items: center;
`, LoginSubDiv = import_styled_components63.default.div`
  display: flex;
  width: 100%;
  height: 100%;
...
`, SH3 = import_styled_components63.default.h3`
  text-align: center;
  color: #646464;
  margin-bottom: 50px;
  font-family: "Nunito";
  ...
  letter-spacing: 0.4px;
  font-weight: 700;
`, Span2 = import_styled_components63.default.span`
  ${(props) => (props.variant === "bold", 'font-family: "Nunito";')}
`, Paragraph = import_styled_components63.default.p`
  text-align: center;
  color: #646464;
  font-family: "Nunito";
  font-size: 18px;
  ...
  margin-top: 50px;
  width: 350px;
`, LeftDiv = import_styled_components63.default.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
...
`, RightDiv = import_styled_components63.default.div`
  display: flex;
  width: 55%;
  align-items: center;
  justify-content: center;
...
`, Slogan2 = import_styled_components63.default.div`
  width: 320px;
...
`, RedDiv = import_styled_components63.default.div`
  width: 20px;
  background-color: var(--color-primary);
  position: absolute;
  height: 100%;
  left: 0;
`, GoldDiv = import_styled_components63.default.div`
  width: 20px;
  background-color: #e5c8a6;
  position: absolute;
  height: 100%;
  left: 20px;
`, AdviceContainer = import_styled_components63.default.div`
  color: white;
  font-size: 15px;
...
init_react();
var assets_manifest_default = { version: "f75650c8", entry: { module: "/build/entry.client-R6DHZFIR.js", imports: ["/build/_shared/chunk-AOIRIE2A.js", "/build/_shared/chunk-CA4B4QDL.js", "/build/_shared/chunk-3WZ3CGWF.js"] }, routes: { root: { id: "root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/root-VUSIXUXM.js", imports: ["/build/_shared/chunk-AELC6KHI.js", "/build/_shared/chunk-CHRNTAPK.js", "/build/_shared/chunk-5M22U5RX.js", "/build/_shared/chunk-VV5N6UAH.js", "/build/_shared/chunk-JC5VNW4X.js", "/build/_shared/chunk-P7BYWKM6.js", "/build/_shared/chunk-CJWDOHQ3.js", "/build/_shared/chunk-UBEID7IU.js", "/build/_shared/chunk-VHH2JG2V.js", "/build/_shared/chunk-T2PNIQNS.js", "/build/_shared/chunk-TOV5KU52.js", "/build/_shared/chunk-2FVL2P6G.js", "/build/_shared/chunk-DTXDYIFC.js", "/build/_shared/chunk-UPCFJQSK.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !0 }, "routes/$": { id: "routes/$", parentId: "root", path: "*", index: void 0, caseSensitive: void 0, module: "/build/routes/$-LV76AEPG.js", imports: ["/build/_shared/chunk-ZJYHTA2X.js"], hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/about": { id: "routes/about", parentId: "root", path: "about", index: void 0, caseSensitive: void 0, module: "/build/routes/about-PCU3UQVH.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/admin": { id: "routes/admin", parentId: "root", path: "admin", index: void 0, caseSensitive: void 0, module: "/build/routes/admin-NRP2IHH4.js", imports: ["/build/_shared/chunk-ZJYHTA2X.js", "/build/_shared/chunk-HSTCQ7IQ.js", "/build/_shared/chunk-VY43IEKO.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !0, hasErrorBoundary: !1 }, "routes/auth/auth0": { id: "routes/auth/auth0", parentId: "root", path: "auth/auth0", index: void 0, caseSensitive: void 0, module: "/build/routes/auth/auth0-KBQ2S7BZ.js", imports: void 0, hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/auth/auth0/callback": { id: "routes/auth/auth0/callback", parentId: "routes/auth/auth0", path: "callback", index: void 0, caseSensitive: void 0, module: "/build/routes/auth/auth0/callback-CN5UOKJC.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/contact": { id: "routes/contact", parentId: "root", path: "contact", index: void 0, caseSensitive: void 0, module: "/build/routes/contact-C2LBFAYJ.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/dashboard": { id: "routes/dashboard", parentId: "root", path: "dashboard", index: void 0, caseSensitive: void 0, module: "/build/routes/dashboard-54ZIPMRE.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/employees/getByDeparment/$id": { id: "routes/employees/getByDeparment/$id", parentId: "root", path: "employees/getByDeparment/:id", index: void 0, caseSensitive: void 0, module: "/build/routes/employees/getByDeparment/$id-BTD55P6L.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/example": { id: "routes/example", parentId: "root", path: "example", index: void 0, caseSensitive: void 0, module: "/build/routes/example-KIWW2AVD.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/index": { id: "routes/index", parentId: "root", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/index-Z4Y7DM6Y.js", imports: ["/build/_shared/chunk-J3GNERB6.js", "/build/_shared/chunk-JCBORQJW.js", "/build/_shared/chunk-RVRN3YQ7.js", "/build/_shared/chunk-BXCUHWCA.js", "/build/_shared/chunk-VY43IEKO.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/login": { id: "routes/login", parentId: "root", path: "login", index: void 0, caseSensitive: void 0, module: "/build/routes/login-EBVXSMSI.js", imports: ["/build/_shared/chunk-J3GNERB6.js", "/build/_shared/chunk-RVRN3YQ7.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/logout": { id: "routes/logout", parentId: "root", path: "logout", index: void 0, caseSensitive: void 0, module: "/build/routes/logout-4LBXPPXN.js", imports: void 0, hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/questions/$questionId": { id: "routes/questions/$questionId", parentId: "root", path: "questions/:questionId", index: void 0, caseSensitive: void 0, module: "/build/routes/questions/$questionId-XPC6E7TB.js", imports: ["/build/_shared/chunk-HSTCQ7IQ.js", "/build/_shared/chunk-JCBORQJW.js", "/build/_shared/chunk-T276QUSN.js", "/build/_shared/chunk-BXCUHWCA.js", "/build/_shared/chunk-VY43IEKO.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/questions/new": { id: "routes/questions/new", parentId: "root", path: "questions/new", index: void 0, caseSensitive: void 0, module: "/build/routes/questions/new-MALLCWUU.js", imports: ["/build/_shared/chunk-RVRN3YQ7.js", "/build/_shared/chunk-T276QUSN.js", "/build/_shared/chunk-BXCUHWCA.js", "/build/_shared/chunk-VY43IEKO.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 } }, url: "/build/manifest-F75650C8.js" };
