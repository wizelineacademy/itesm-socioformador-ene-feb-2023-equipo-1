...
// app/utils/hooks/useUser.js
function useUser() {
  let loader15 = useFindLoaderMatch_default("root");
  if (!(!loader15 || !loader15.data))
    return loader15.data.profile;
}
...
function useGlobalSuccessMessage() {
  let loader15 = useFindLoaderMatch_default("root");
  if (!(!loader15 || !loader15.data))
    return loader15.data.globalSuccess;
}
...
var loader7 = async ({ request }) => {
  await requireAuth(request);
  let url = new URL(request.url), department = Number.parseInt(url.searchParams.get("department"), 10), questionsFAQ = await list_default({
...
init_react();
var import_react87 = require("react"), import_react88 = require("@remix-run/react"), import_node8 = require("@remix-run/node"), import_styled_components49 = __toESM(require("styled-components"));
var loader9 = async ({ request }) => {
  await requireAuth(request);
  let questionsFAQ = await list_default({
    orderBy: "popular",
...
}, FaqContainer = import_styled_components49.default.div`
  position: fixed;
  top: 0;
  right: 0;
  width: 300px;
...
`, FaqList = import_styled_components49.default.ul`
  list-style: none;
  padding: 0;
  margin: 20px;
`, FaqItem = import_styled_components49.default.li`
  margin-bottom: 10px;
  cursor: pointer;
`, FaqLink = import_styled_components49.default.a`
  color: #333;
  text-decoration: none;
  &:hover {
    color: #000;
...
`;
function Chatbot() {
  let { questionsFAQ } = (0, import_react88.useLoaderData)();
  return (0, import_react87.useEffect)(() => {
    console.log(questionsFAQ);
  }, [questionsFAQ]), /* @__PURE__ */ React.createElement(FaqContainer, null, /* @__PURE__ */ React.createElement(FaqList, null, questionsFAQ.map((faq, index2) => /* @__PURE__ */ React.createElement(FaqItem, {
    key: index2
...
var action4 = async ({ request }) => logout(request), loader10 = async () => (0, import_node9.redirect)("/logout");
...
init_react();
var import_react89 = __toESM(require("react")), import_node10 = require("@remix-run/node");
...
// app/routes/about.jsx
var loader11 = async ({ request }) => (await requireAuth(request), (0, import_node10.json)({}));
function About2() {
...
init_react();
var import_react98 = __toESM(require("react")), import_node11 = require("@remix-run/node"), import_react99 = require("@remix-run/react");
...
init_react();
var import_react93 = __toESM(require("react")), import_prop_types52 = __toESM(require("prop-types"));
...
init_react();
var import_react91 = __toESM(require("react")), import_prop_types51 = __toESM(require("prop-types")), import_react92 = require("@remix-run/react");
...
init_react();
var import_prop_types53 = __toESM(require("prop-types")), import_react95 = __toESM(require("react"));
...
`, IconWrapper3 = import_styled_components54.default.div`
  ...
  align-items: center;
  justify-content: center;
`, Input4 = import_styled_components54.default.input`
  background-color: transparent;
  border: none;
  font-size: 14px;
  height: 100%;
...
init_react();
var import_node12 = require("@remix-run/node"), import_react111 = require("@remix-run/react"), import_react112 = __toESM(require("react"));
...
init_react();
var import_react109 = __toESM(require("react")), import_react110 = require("@remix-run/react"), import_prop_types59 = __toESM(require("prop-types"));
...
init_react();
var import_react101 = __toESM(require("react")), import_prop_types54 = __toESM(require("prop-types")), import_react_router_dom3 = require("react-router-dom");
...
function GoToTopButton() {
  ...
  }, []), /* @__PURE__ */ import_react103.default.createElement(Button3, {
    id: "go-to-top-button",
    display: show,
    onClick: () => {
      window.scrollTo({
...
init_react();
var import_react104 = __toESM(require("react")), import_prop_types55 = __toESM(require("prop-types"));
...
init_react();
var import_react106 = __toESM(require("react")), import_prop_types57 = __toESM(require("prop-types")), import_react107 = require("@remix-run/react");
...
init_react();
var import_react108 = __toESM(require("react")), import_prop_types58 = __toESM(require("prop-types"));
...
function ListQuestions({
  ...
  return /* @__PURE__ */ import_react109.default.createElement(Container8, null, /* @__PURE__ */ import_react109.default.createElement(LeftWrapper, null, /* @__PURE__ */ import_react109.default.createElement(SloganWrapper, null, /* @__PURE__ */ import_react109.default.createElement(Slogan_default, null))), /* @__PURE__ */ import_react109.default.createElement(CenterWrapper, null, /* @__PURE__ */ import_react109.default.createElement(QuestionsWrapper, null, /* @__PURE__ */ import_react109.default.createElement(AskQuestionButtonWrapper, null, /* @__PURE__ */ import_react109.default.createElement(QuestionsTitle, null, title), (() => /* @__PURE__ */ import_react109.default.createElement(AskButton, {
    ...
    modifyQuery,
    clearFilters
  }))), /* @__PURE__ */ import_react109.default.createElement(GoToTopButton_default, null), valuesMessageModal, /* @__PURE__ */ import_react109.default.createElement(AnswerBot_default, null));
}
...
var loader13 = async ({ request }) => {
  ...
  return (0, import_node12.json)(response);
};
function Index() {
  let { questions: initialQuestions } = (0, import_react111.useLoaderData)(), [questions, setQuestions] = (0, import_react112.useState)(initialQuestions), fetcher = (0, import_react111.useFetcher)(), [shouldFetch, setShouldFetch] = (0, import_react112.useState)(!0), [page, setPage] = (0, import_react112.useState)(2), [searchParams] = (0, import_react111.useSearchParams)(), onFetchMore = () => {
...
init_react();
var import_react115 = __toESM(require("react")), import_node13 = require("@remix-run/node");
...
// app/routes/login.jsx
var loader14 = async ({ request }) => await getAuthenticatedUser(request) ? (0, import_node13.redirect)("/") : (0, import_node13.json)({});
function Login() {
