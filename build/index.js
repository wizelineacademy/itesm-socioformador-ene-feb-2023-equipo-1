...
// app/controllers/answerBot/pdfConv.js
var endpoint = `http://${FLASK_ENDPOINT}:3000/api/pdf_conversation_gpt`, pdfConv = async (conversation) => fetch("http://127.0.0.1:3000/api/pdf_conversation_gpt", {
  method: "POST",
