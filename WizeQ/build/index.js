...
function ErrorBoundary({ error }) {
  return console.error(error), /* @__PURE__ */ import_react23.default.createElement("html", {
    lang: "es"
...
function Notifications() {
  ...
  return (0, import_react66.useEffect)(() => {
    ...
    error && (console.error(error.detail), import_react_toastify.toast.error(error.message, DEFAULT_TOAST_CONFIG)), errors && Array.isArray(errors) && errors.forEach((_error) => {
      console.error(_error.detail), import_react_toastify.toast.error(_error.message, DEFAULT_TOAST_CONFIG);
...
init_react();
var import_react78 = __toESM(require("react")), import_bs5 = require("react-icons/bs"), import_node4 = require("@remix-run/node"), import_react79 = require("@remix-run/react");
...
function CreateQuestion() {
  let { locations, departments } = (0, import_react79.useLoaderData)(), submit = (0, import_react79.useSubmit)(), formRef = (0, import_react78.useRef)();
  (0, import_react78.useEffect)(() => {
    departments.unshift({ name: "I don't know whom to assign it.", department_id: import_constants63.NOT_ASSIGNED_DEPARTMENT_ID });
  }, []);
  let renderBulletPoint = () => /* @__PURE__ */ import_react78.default.createElement("div", null, /* @__PURE__ */ import_react78.default.createElement(import_bs5.BsCircleFill, {
    color: "var(--color-secondary)",
    size: "7px",
    style: { marginTop: "3px", marginRight: "10px" }
  }));
  return /* @__PURE__ */ import_react78.default.createElement(import_react78.default.Fragment, null, /* @__PURE__ */ import_react78.default.createElement(Notifications_default, null), /* @__PURE__ */ import_react78.default.createElement(QuestionDiv, null, /* @__PURE__ */ import_react78.default.createElement(QuestionSlogan, null, /* @__PURE__ */ import_react78.default.createElement(Slogan_default, null)), /* @__PURE__ */ import_react78.default.createElement(QuestionInput, null, /* @__PURE__ */ import_react78.default.createElement(QuestionForm_default, {
    ...
    locations,
    departments
  })), /* @__PURE__ */ import_react78.default.createElement(QuestionRecommendations2, null, /* @__PURE__ */ import_react78.default.createElement(RecommendationsContainer2, null, /* @__PURE__ */ import_react78.default.createElement(Recommendations2, null, /* @__PURE__ */ import_react78.default.createElement("span", null, "Things to keep in mind"), RECOMMENDATIONS_QUESTION.map((text5) => /* @__PURE__ */ import_react78.default.createElement("span", {
    key: text5
  }, renderBulletPoint(), text5)))))));
}
...
init_react();
var import_react82 = __toESM(require("react")), import_prop_types48 = __toESM(require("prop-types")), import_node6 = require("@remix-run/node");
...
// app/styles/Contact.Styled.jsx
var FooterDiv = import_styled_components44.default.div`
    background-color: #f4f7f9;
    color: #a2abaf;
    font-size: 12px;
    margin-left: auto;
...
`, FooterContainer = import_styled_components44.default.div`
    margin-right: auto;
    margin-left: auto;
    padding-left: 15px;
    padding-right: 15px;
...
`, FooterLink = import_styled_components44.default.a`
    color: #666;

    &:hover {
        text-decoration: underline;
    }
`, ContactInputDiv = import_styled_components44.default.div`
    background-color: #f4f7f9;
    box-sizing: border-box;
    ...
    position: relative;
    text-align: center;
`, ContactForm = import_styled_components44.default.form`
    align-items: center;
    display: flex;
    flex-direction: column;
    margin: auto;
    ...
    max-width: 390px;
    width: 100%;
`, ContactFormP = import_styled_components44.default.p`
    border-radius: 4px;
    box-sizing: border-box;
    display: inline-block;
    margin: 10px 0;
    ...
    color: var(--color-dark-50);
    line-height: 24px;
`, ContactSelect = import_styled_components44.default.select`
    ...
    padding: 12px 16px;
    width: 100%;
`, ContactTextArea = import_styled_components44.default.textarea`
    border: 1px solid #ccc;
    height: 150px;
    border-radius: 4px;
    box-sizing: border-box;
    ...
    border-radius: 4px;
    box-sizing: border-box;
`, BtnContainer = import_styled_components44.default.div`
    padding: 12px 0;
    border-radius: 4px;
    box-sizing: border-box;
    display: inline-block;
    ...
    max-width: 390px;
    width: 100%;
`, SubmitBtn = import_styled_components44.default.button`
    background-color: var(--color-secondary);
    border-radius: 3px;
    border: none;
    color: #fff;
...
`, SuccessDiv = import_styled_components44.default.div`
    background-color: white;
    color: var(--color-dark-50);
    margin-top: 50px;
    max-width: 500px;
...
`, ContactCardDiv = import_styled_components44.default.div`
    background-color: #1c1c1c;
`, ContactInputHeader = import_styled_components44.default.div`
    background-color: #fff;
    text-align: center;
    font-size: 14px;
    margin: 0 auto;
    box-sizing: border-box;
`, ContactInputHeaderH1 = import_styled_components44.default.h1`
    color: #a2abaf;
    ...
    margin: 0 auto;
    max-width: 390px;
`, ContactInputHeaderH2 = import_styled_components44.default.h2`
    color: var(--color-dark-50);
    font-size: 24px;
    font-weight: 600;
    padding: 12px 0 8px;
    margin: 0 auto;
    max-width: 390px;
`, ContactInputHeaderP = import_styled_components44.default.p`
    color: var(--color-dark-50);
    letter-spacing: 0.6px;
    line-height: 1.71;
    ...
    margin: 0 auto;
    max-width: 390px;
`, ContactInputSitesDiv = import_styled_components44.default.div`
    display: flex;
    flex-wrap: wrap;
    justify-content: space-around;
    margin: 0 auto;
    max-width: 390px;
`, ContactInputGoTo = import_styled_components44.default.div`
    margin: 20px 40px 40px;
    max-width: 390px;
`, ContactInputGoToP = import_styled_components44.default.p`
    font-size: 16px;
    margin: 8px 0 4px;
    padding: 0;
    max-width: 390px;
`, ContactInputGoToA = import_styled_components44.default.a`
    padding: 4px 0;
    white-space: nowrap;
    color: var(--color-secondary);
    margin: 0 auto;
    max-width: 390px;
`, ContactInputGoToImg = import_styled_components44.default.img`
    background-color: #f4f7f9;
    border-radius: 50%;
...
// app/components/Footer.jsx
var Footer = class extends import_react80.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    return /* @__PURE__ */ import_react80.default.createElement(FooterDiv, null, /* @__PURE__ */ import_react80.default.createElement(FooterContainer, null, /* @__PURE__ */ import_react80.default.createElement(FooterLink, {
...
init_react();
var import_react81 = __toESM(require("react")), import_prop_types47 = __toESM(require("prop-types"));
function ContactGoto(props) {
  ...
  return /* @__PURE__ */ import_react81.default.createElement(ContactInputGoTo, null, /* @__PURE__ */ import_react81.default.createElement(ContactInputGoToImg, {
    src: icon
  }), /* @__PURE__ */ import_react81.default.createElement(ContactInputGoToP, null, text5), /* @__PURE__ */ import_react81.default.createElement(ContactInputGoToA, {
    href: dir,
    target: "_blank",
    rel: "noopener noreferrer"
  }, goto));
...
var loader7 = async ({ request }) => (await requireAuth(request), (0, import_node6.json)({})), initialState = {
  ...
  let { full_name: name, email } = useUser_default(), [state, setState] = (0, import_react82.useState)(initialState), resetForm = () => {
    setState(initialState);
  }, handleContactClick = () => {
    resetForm();
  }, renderSuccessMessage = () => /* @__PURE__ */ import_react82.default.createElement(SuccessDiv, null, /* @__PURE__ */ import_react82.default.createElement("p", null, "Thanks for contacting us! We will review your feedback shortly."), /* @__PURE__ */ import_react82.default.createElement("p", null, "Click", " ", /* @__PURE__ */ import_react82.default.createElement("button", {
    type: "button",
    onClick: handleContactClick
  }, " here "), " ", "to contact us again."), /* @__PURE__ */ import_react82.default.createElement("p", null, "Cheers,", /* @__PURE__ */ import_react82.default.createElement("br", null), " ", "The WizeQ team!")), renderOptionsList = () => CONTACT_REASONS_LIST.map((options) => /* @__PURE__ */ import_react82.default.createElement("option", {
    value: options.value,
    key: options.value
    ...
    return /* @__PURE__ */ import_react82.default.createElement(ContactForm, {
      onSubmit
    }, /* @__PURE__ */ import_react82.default.createElement(ContactFormP, null, "Hi", /* @__PURE__ */ import_react82.default.createElement("strong", null, " ", firstName), "!", /* @__PURE__ */ import_react82.default.createElement("br", null), "Send us a message!"), /* @__PURE__ */ import_react82.default.createElement(ContactSelect, {
      name: "reason",
      onChange: onInputChange
    }, renderOptionsList()), /* @__PURE__ */ import_react82.default.createElement(ContactTextArea, {
      name: "message",
      placeholder: state.placeholders.message,
      onChange: onInputChange
    }), /* @__PURE__ */ import_react82.default.createElement(BtnContainer, null, /* @__PURE__ */ import_react82.default.createElement(SubmitBtn, {
      type: "submit"
    }, "Submit")));
  };
  return /* @__PURE__ */ import_react82.default.createElement(ContactCardDiv, null, /* @__PURE__ */ import_react82.default.createElement(ContactInputHeader, null, /* @__PURE__ */ import_react82.default.createElement(ContactInputHeaderH1, null, "Contact Us"), /* @__PURE__ */ import_react82.default.createElement(ContactInputHeaderH2, null, "We are here for you!"), /* @__PURE__ */ import_react82.default.createElement(ContactInputHeaderP, null, "We\u2019d love to hear from you, please let us know what you think and get in touch with us.", " "), /* @__PURE__ */ import_react82.default.createElement(ContactInputSitesDiv, null, /* @__PURE__ */ import_react82.default.createElement(ContactGoto_default, {
    icon: ic_email_default,
    text: "Email us at",
    goto: "wizeq@wizeline.com",
    dir: "mailto:wizeq@wizeline.com"
  }), /* @__PURE__ */ import_react82.default.createElement(ContactGoto_default, {
    icon: ic_slack_default,
    text: "Slack us at",
    goto: "#wize-q-support",
    dir: "https://wizeline.slack.com/messages/C6M652THT"
  }))), /* @__PURE__ */ import_react82.default.createElement(ContactInputDiv, null, (() => state.isSubmitted ? state.isSubmitted ? renderSuccessMessage() : null : renderContactForm())()), /* @__PURE__ */ import_react82.default.createElement(Footer_default, null));
};
Contact.propTypes = {
...
init_react();
var import_react83 = __toESM(require("react")), import_node8 = require("@remix-run/node");

// app/styles/About.Styled.jsx
init_react();
var import_styled_components45 = __toESM(require("styled-components")), colorDark50 = "#4E5154", colorSecondary = "#00A7E5", About = import_styled_components45.default.div`
  background-color: #fff;
  color: ${colorDark50};
  line-height: 1.71;
  text-align: center;
`, AboutBody = import_styled_components45.default.div`
  margin: auto;
  max-width: 65%;
  padding: 0 20px;
...
`, BoxWrapper = import_styled_components45.default.div`
  display: flex;
  flex-direction: row;
  justify-content: space-between;
  flex-wrap: wrap;
`, BoxContainer = import_styled_components45.default.div`
    padding: 16px;
...
`, BoxImageContainer = import_styled_components45.default.div`
display: inline-block;
height: 48px;
margin-right: 8px;
`, BoxImage = import_styled_components45.default.img`
  float: left;
  margin: 28px;
...
`, BoxBoldText = import_styled_components45.default.div`
  color: ${colorDark50};
...
`, BoxMetadata = import_styled_components45.default.div`
  margin: 28px;
  text-align: left;
`, AboutMetadata = import_styled_components45.default.div`
  @media (max-width: 767px)  {
    margin-top: 24px;
  }
`, AboutWhatElseContainer = import_styled_components45.default.div`
  margin-bottom: 28px;
  margin-top: 28px;
`, AboutWhatElseImg = import_styled_components45.default.img`
  float: right;
  margin-left: 100px;
  margin-right: 28px;
...
`, AboutWHatElseText = import_styled_components45.default.div`
  margin-top: 44px;
  text-align: left;
  width: 70%;
...
`, AboutWHatElseBold = import_styled_components45.default.div`
  color: ${colorDark50};
  font-family: "NunitoSans Semibold";
  margin-top: 44px;
  margin: 28px;
  text-align: left;
`, AboutWhatElseMetadata = import_styled_components45.default.div`
  margin: 28px;
  text-align: left;
`, AboutFooter = import_styled_components45.default.div`
  padding: 50px 0;
...
function About2() {
  return /* @__PURE__ */ import_react83.default.createElement(About, null, /* @__PURE__ */ import_react83.default.createElement(AboutBody, null, /* @__PURE__ */ import_react83.default.createElement("h1", null, "About Us"), /* @__PURE__ */ import_react83.default.createElement("h2", null, "This is Wizeline Questions"), /* @__PURE__ */ import_react83.default.createElement("p", null, /* @__PURE__ */ import_react83.default.createElement("strong", null, "Wizeline Questions (WizeQ)"), " ", "is a communication space where you can express your ideas, learn more about Wizeline, and ask all kinds of questions."), /* @__PURE__ */ import_react83.default.createElement("p", null, "Wizeline Questions is a knowledge base where you can ask for information to a specific department and allow other Wizeliners to benefit from it. For example:"), /* @__PURE__ */ import_react83.default.createElement(BoxWrapper, null, /* @__PURE__ */ import_react83.default.createElement(BoxContainer, null, /* @__PURE__ */ import_react83.default.createElement(BoxImageContainer, null, /* @__PURE__ */ import_react83.default.createElement(BoxImage, {
    src: ic_meeting_default
  }), /* @__PURE__ */ import_react83.default.createElement(BoxBoldText, null, "Are you still having problems with Zoom for your next meeting?")), /* @__PURE__ */ import_react83.default.createElement(BoxMetadata, null, "Check Wizeline Questions, someone might have already asked IT the same question. If that is not the case, this is your chance to shine!")), /* @__PURE__ */ import_react83.default.createElement(BoxContainer, null, /* @__PURE__ */ import_react83.default.createElement(BoxImageContainer, null, /* @__PURE__ */ import_react83.default.createElement(BoxImage, {
    src: ic_saving_fund_default
  }), /* @__PURE__ */ import_react83.default.createElement(BoxBoldText, null, "Do you want to know more about the savings fund?")), /* @__PURE__ */ import_react83.default.createElement(BoxMetadata, null, "Tag People Ops in your question, other Wizeliners will be glad to learn about that same topic, for sure!"))), /* @__PURE__ */ import_react83.default.createElement(AboutMetadata, null, /* @__PURE__ */ import_react83.default.createElement("p", null, "Information can be easily lost in the flood of comments and pinged posts on Slack. Do you need information to persist?", " ", /* @__PURE__ */ import_react83.default.createElement("strong", null, "Use Wizeline Questions instead!"))), /* @__PURE__ */ import_react83.default.createElement("h3", null, "What else?"), /* @__PURE__ */ import_react83.default.createElement(AboutWhatElseContainer, null, /* @__PURE__ */ import_react83.default.createElement(AboutWhatElseImg, {
    src: ic_dialogue_default
  }), /* @__PURE__ */ import_react83.default.createElement(AboutWHatElseText, null, /* @__PURE__ */ import_react83.default.createElement(AboutWHatElseBold, null, "Start a conversation. Is there a topic you want to discuss with other Wizeliners?"), /* @__PURE__ */ import_react83.default.createElement(AboutWhatElseMetadata, null, "This is the place!. You can reply to a question and also hold interesting conversations with other Wizeliners.  Use it as a discussion forum, suggestion what-else, or simply visit to say hello! Help us to keep Wizeline an amazing place!"))), /* @__PURE__ */ import_react83.default.createElement(AboutWhatElseContainer, null, /* @__PURE__ */ import_react83.default.createElement(AboutWhatElseImg, {
    src: ic_anonymous_default
  }), /* @__PURE__ */ import_react83.default.createElement(AboutWHatElseText, null, /* @__PURE__ */ import_react83.default.createElement(AboutWHatElseBold, null, "Is there a sensitive question you want to ask anonymously?"), /* @__PURE__ */ import_react83.default.createElement(AboutWhatElseMetadata, null, "Ask on Wizeline Questions! To promote ownership and open communication, it displays your user name by default when you post a new question. But you can always opt for anonymity."))), /* @__PURE__ */ import_react83.default.createElement("h3", null, "Things to Keep in Mind When Asking a Question"), /* @__PURE__ */ import_react83.default.createElement("span", null, /* @__PURE__ */ import_react83.default.createElement("p", null, "We value your ideas, questions, suggestions, and comments. Therefore, we encourage you to use this communication space. Please, when writing a new question or a comment follow these recommendations:"), /* @__PURE__ */ import_react83.default.createElement("div", {
    style: { textAlign: "justify" }
  }, /* @__PURE__ */ import_react83.default.createElement("ul", null, /* @__PURE__ */ import_react83.default.createElement("li", null, "Strive for constructive open communication. Avoid vagueness."), /* @__PURE__ */ import_react83.default.createElement("li", null, "Do not demean or degrade others because of their gender, race, age, religion, etc."), /* @__PURE__ */ import_react83.default.createElement("li", null, "Avoid posting questions that include sexually explicit comments, hate speech, prejudicial remarks, and profanity."), /* @__PURE__ */ import_react83.default.createElement("li", null, "Do not mock other members, their comments, profiles, threads, or experiences. Remember, what is funny for you may be offensive to others."))))), /* @__PURE__ */ import_react83.default.createElement(AboutFooter, null, /* @__PURE__ */ import_react83.default.createElement("p", null, /* @__PURE__ */ import_react83.default.createElement("strong", null, "We need your help!"), " ", "Wizeline Questions is an internal project and everyone can contribute. Come aboard and meet the team at", /* @__PURE__ */ import_react83.default.createElement("a", {
    href: "https://wizeline.slack.com/archives/C031D9DP7C2",
    target: "_blank",
    rel: "noopener noreferrer"
  }, "#wize-q-2022"), ". You can take a look at our", /* @__PURE__ */ import_react83.default.createElement("a", {
...
init_react();
var import_react92 = __toESM(require("react")), import_node9 = require("@remix-run/node"), import_react93 = require("@remix-run/react");

// app/styles/Admin.Styled.jsx
init_react();
var import_styled_components46 = __toESM(require("styled-components")), Container4 = import_styled_components46.default.div`
  display: flex;
  flex-wrap: wrap;
  justify-content: space-between;
  align-items: center;
...
init_react();
var import_react84 = require("react"), DOTS = "...", range = (start, end) => {
...
init_react();
var import_styled_components47 = __toESM(require("styled-components")), import_react_bootstrap11 = require("react-bootstrap"), TableContainer = import_styled_components47.default.div`
  display: flex;
  justify-content: center;
  flex-direction: column;
  margin: 2rem auto;
...
`, UserTable = import_styled_components47.default.table`
  display: flex;
  justify-content: center;
  flex-direction: column;
  margin: 2rem auto;
...
`, RowTable = import_styled_components47.default.tr`
  padding: 0.5rem 0;
  border: 1px solid #f2efed;
  .row-btn {
    margin: 0;
...
`, HeaderTable = import_styled_components47.default.tr`
  background-color: #f4f7f9;
  padding: 1rem 0;
  th {
    font-size: 1.5rem;
...
`, PaginationContainer = import_styled_components47.default.div`
  display: flex;
  justify-content: space-between;
  margin: 0.5rem auto;
  padding: 1.5rem 0;
...
`, FilterDropdown = (0, import_styled_components47.default)(import_react_bootstrap11.DropdownButton)`
  background: transparent;
  border: none;
  font-size: 1.5rem;
  color: #524f4e;
...
`, TablePagination = (0, import_styled_components47.default)(import_react_bootstrap11.Pagination)`
 background-color: white;  
`, Alert2 = import_styled_components47.default.div`
  display: flex;
...
init_react();
var import_react85 = __toESM(require("react")), import_prop_types49 = __toESM(require("prop-types")), import_react86 = require("@remix-run/react");

// app/components/Modals/EditUserModal/EditUserModal.Styled.jsx
init_react();
var import_styled_components48 = __toESM(require("styled-components")), Wrapper = import_styled_components48.default.div`
  background-color: rgba(0, 0, 0, 0.5);
  position: fixed;
  top: 50%;
  left: 50%;
  ...
  align-items: center;
  z-index: 1050;
`, Container5 = import_styled_components48.default.div`
  font-family: "Nunito", sans-serif;
  font-size: 14px;
  border-radius: 15px;
  background-color: white;
...
`, User = import_styled_components48.default.div`
  display: flex;
  flex-direction: row;
  align-items: center;
  justify-content: flex-start;
...
`, UserInfo = import_styled_components48.default.div`
  margin-left: 20px;
  display: flex;
  flex-direction: column;
  justify-content: space-around;
...
`, Roles = import_styled_components48.default.div`
  display: flex;
  flex-direction: column;
  justify-content: flex-start;
  padding: 15px 25px;
`, RolesTable = import_styled_components48.default.div`
  border-radius: 15px;
  border: 1px solid #d8d8d8;
  margin: 10px 0 0;
`, TableRow = import_styled_components48.default.ul`
...
`, ButtonContainer = import_styled_components48.default.div`
  margin-top: 25px;
  display: flex;
  flex-direction: row;
  justify-content: flex-end;
...
function EditUserModal({ user, onClose }) {
  let [uAdmin, setUAdmin] = (0, import_react85.useState)(user.is_admin), [uJobTitle, setUJobTitle] = (0, import_react85.useState)(user.job_title);
  return /* @__PURE__ */ import_react85.default.createElement(Wrapper, null, /* @__PURE__ */ import_react85.default.createElement(import_react86.Form, {
    method: "post"
  }, /* @__PURE__ */ import_react85.default.createElement(Container5, null, /* @__PURE__ */ import_react85.default.createElement(User, null, /* @__PURE__ */ import_react85.default.createElement(UserImage_default, {
    src: user.profile_picture,
    size: "extra big"
  }), /* @__PURE__ */ import_react85.default.createElement(UserInfo, null, /* @__PURE__ */ import_react85.default.createElement("h2", null, user.full_name), /* @__PURE__ */ import_react85.default.createElement("span", null, /* @__PURE__ */ import_react85.default.createElement("b", null, user.job_title !== null ? user.job_title : "")), /* @__PURE__ */ import_react85.default.createElement("span", null, user.email))), /* @__PURE__ */ import_react85.default.createElement(Roles, null, /* @__PURE__ */ import_react85.default.createElement("h3", null, "Roles"), /* @__PURE__ */ import_react85.default.createElement("span", null, "Edit roles for this user"), /* @__PURE__ */ import_react85.default.createElement(RolesTable, null, /* @__PURE__ */ import_react85.default.createElement(TableRow, {
    noBorder: !0
  }, /* @__PURE__ */ import_react85.default.createElement("li", null, /* @__PURE__ */ import_react85.default.createElement("b", null, "Name")), /* @__PURE__ */ import_react85.default.createElement("li", null, /* @__PURE__ */ import_react85.default.createElement("b", null, "Action"))), /* @__PURE__ */ import_react85.default.createElement(TableRow, null, /* @__PURE__ */ import_react85.default.createElement("li", null, "Job Title"), /* @__PURE__ */ import_react85.default.createElement("li", null, /* @__PURE__ */ import_react85.default.createElement("input", {
    name: "job_title",
    type: "text",
    value: uJobTitle,
    onChange: (e) => {
  ...
  }))), /* @__PURE__ */ import_react85.default.createElement(TableRow, null, /* @__PURE__ */ import_react85.default.createElement("li", null, "Role Title"), /* @__PURE__ */ import_react85.default.createElement("li", null, "Employee", user.is_admin && ", Admin")), /* @__PURE__ */ import_react85.default.createElement(TableRow, null, /* @__PURE__ */ import_react85.default.createElement("li", null, "Admin"), /* @__PURE__ */ import_react85.default.createElement("li", null, /* @__PURE__ */ import_react85.default.createElement("input", {
    name: "is_admin",
    type: "checkbox",
    checked: uAdmin,
    onChange: (e) => {
  ...
  })))), /* @__PURE__ */ import_react85.default.createElement(ButtonContainer, null, /* @__PURE__ */ import_react85.default.createElement(Button_default, {
    category: SECONDARY_BUTTON,
    onClick: onClose
  }, "Cancel"), /* @__PURE__ */ import_react85.default.createElement(Button_default, {
    category: PRIMARY_BUTTON,
    type: "submit"
  }, "Save")))), /* @__PURE__ */ import_react85.default.createElement("input", {
    type: "hidden",
    name: "employee_id",
...
function AdminUsersTable({
  ...
  let [modal, setModal] = (0, import_react87.useState)(!1), [currentUser, setCurrenUser] = (0, import_react87.useState)({}), quantityRef = (0, import_react87.useRef)(0), paginationRange = usePagination({
    currentPage: currentPage === 0 ? 1 : currentPage + 1,
    totalPages
  }), [, setSearchParams] = (0, import_react88.useSearchParams)(), data = (0, import_react88.useActionData)();
  ...
  }, createPaginationItem = (i, idx) => /* @__PURE__ */ import_react87.default.createElement(TablePagination.Item, {
    key: idx,
    onClick: () => changePage(i),
    active: i === currentPage
  }, i), paginationItems = (() => [...paginationRange.map((__page, idx) => __page === DOTS ? /* @__PURE__ */ import_react87.default.createElement(TablePagination.Ellipsis, {
    key: idx
  }) : createPaginationItem(__page, idx))])(), renderHeader = () => /* @__PURE__ */ import_react87.default.createElement("thead", null, /* @__PURE__ */ import_react87.default.createElement(HeaderTable, null, /* @__PURE__ */ import_react87.default.createElement("th", null, "Name"), /* @__PURE__ */ import_react87.default.createElement("th", {
    className: "table-desktop-view"
  }, "Email"), /* @__PURE__ */ import_react87.default.createElement("th", {
    className: "table-desktop-view"
  }, "Job Title"), /* @__PURE__ */ import_react87.default.createElement("th", {
    className: "table-desktop-view"
  }, "Roles"), /* @__PURE__ */ import_react87.default.createElement("th", null, "Action"))), setQTY = (value) => {
    setSearchParams({
      size: value,
      page: currentPage
    });
  };
  return !users.length && !isLoading ? /* @__PURE__ */ import_react87.default.createElement(Alert2, null, /* @__PURE__ */ import_react87.default.createElement("span", {
    className: "message"
  }, "There are no results to show")) : /* @__PURE__ */ import_react87.default.createElement("div", null, /* @__PURE__ */ import_react87.default.createElement(TableContainer, null, "Select the number of results", /* @__PURE__ */ import_react87.default.createElement("select", {
    ref: quantityRef,
    onChange: (e) => setQTY(e.target.value),
    defaultValue: size
  }, /* @__PURE__ */ import_react87.default.createElement("option", {
    value: "5"
  }, "5"), /* @__PURE__ */ import_react87.default.createElement("option", {
    value: "10"
  }, "10"), /* @__PURE__ */ import_react87.default.createElement("option", {
    value: "15"
  }, "15"), /* @__PURE__ */ import_react87.default.createElement("option", {
    value: "20"
  }, "20"), /* @__PURE__ */ import_react87.default.createElement("option", {
    value: "25"
  }, "25")), isLoading ? /* @__PURE__ */ import_react87.default.createElement("div", null, /* @__PURE__ */ import_react87.default.createElement(UserTable, null, renderHeader()), /* @__PURE__ */ import_react87.default.createElement(Loader_default, {
    src: logomark_medium_default,
    size: LSPIN_MEDIUM
  })) : /* @__PURE__ */ import_react87.default.createElement(UserTable, null, renderHeader(), /* @__PURE__ */ import_react87.default.createElement("tbody", null, users.map((user) => /* @__PURE__ */ import_react87.default.createElement(RowTable, {
    key: user.employee_id
  }, /* @__PURE__ */ import_react87.default.createElement("td", null, /* @__PURE__ */ import_react87.default.createElement("div", null, /* @__PURE__ */ import_react87.default.createElement("img", {
    src: user.profile_picture,
    alt: ""
  }), user.full_name)), /* @__PURE__ */ import_react87.default.createElement("td", {
    className: "table-desktop-view"
  }, user.email), /* @__PURE__ */ import_react87.default.createElement("td", {
    className: "table-desktop-view"
  }, user.job_title), /* @__PURE__ */ import_react87.default.createElement("td", {
    className: "table-desktop-view"
  }, "Employee", user.is_admin && ", Admin"), /* @__PURE__ */ import_react87.default.createElement("td", null, /* @__PURE__ */ import_react87.default.createElement(Button_default, {
    category: PRIMARY_BUTTON,
    onClick: () => handleModal(user),
    className: "row-btn"
  }, "Edit roles")))))), !isLoading && /* @__PURE__ */ import_react87.default.createElement(PaginationContainer, null, /* @__PURE__ */ import_react87.default.createElement("div", null, "Page", " ", currentPage, " ", "of", " ", totalPages), /* @__PURE__ */ import_react87.default.createElement(TablePagination, {
    boundarylinks: "true"
  }, currentPage > 1 && /* @__PURE__ */ import_react87.default.createElement(TablePagination.Prev, {
    onClick: prevPageHandler
  }), paginationItems, currentPage < totalPages && /* @__PURE__ */ import_react87.default.createElement(TablePagination.Next, {
    onClick: nextPageHandler
  }))), modal ? /* @__PURE__ */ import_react87.default.createElement(EditUserModal_default, {
    user: currentUser,
    onClose: () => handleModal()
  }) : null));
}
...
init_react();
var import_prop_types51 = __toESM(require("prop-types")), import_react89 = __toESM(require("react"));

// app/components/UserSearchBar/UserSearchBar.Styled.jsx
init_react();
var import_styled_components49 = __toESM(require("styled-components")), import_md7 = require("react-icons/md"), import_ai3 = require("react-icons/ai"), SearchField2 = import_styled_components49.default.div`
  align-items: center;
  display: flex;
  background-color: #fff;
  border: 1px solid #d3d3d4;
  ...
  width: 100%;
  transition: all 0.5s ease;
`, IconWrapper3 = import_styled_components49.default.div`
  left: 10px;
  top: auto;
  width: 22px;
  position: absolute;
  ...
  align-items: center;
  justify-content: center;
`, Input3 = import_styled_components49.default.input`
  background-color: transparent;
  border: none;
  font-size: 14px;
  height: 100%;
...
`, SearchIcon3 = (0, import_styled_components49.default)(import_ai3.AiOutlineSearch)`
  font-size: 30px;
  color: rgba(78, 81, 84, 0.65);
`, ClearIcon2 = (0, import_styled_components49.default)(import_md7.MdClose)`
  font-size: 28px;
  color: rgba(78, 81, 84, 0.65);
  padding: 5px;
  transition: all 0.3s ease-in-out;
...
function UserSearchBar({ onSearch }) {
  let [search2, setSearch] = (0, import_react89.useState)("");
  return /* @__PURE__ */ import_react89.default.createElement(SearchField2, null, /* @__PURE__ */ import_react89.default.createElement(IconWrapper3, null, /* @__PURE__ */ import_react89.default.createElement(SearchIcon3, null)), /* @__PURE__ */ import_react89.default.createElement(Input3, {
    type: "search",
    value: search2,
    onChange: (e) => {
  ...
  }), search2 && /* @__PURE__ */ import_react89.default.createElement(Button_default, {
    type: "button",
    className: "clear-button",
    title: "Clear",
    category: ICON_BUTTON,
  ...
  }, /* @__PURE__ */ import_react89.default.createElement(ClearIcon2, null)));
}
...
init_react();
var import_styled_components50 = __toESM(require("styled-components")), import_react90 = require("@remix-run/react");
...
// app/styles/NotFound.Styled.jsx
var BackgroundDiv = import_styled_components50.default.div`
    ...
    width: 100%;
    z-index: -1;
`, MainDiv = import_styled_components50.default.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
    height: 60rem;
    margin-top: 3.5rem;
    width: 100%;
`, Container6 = import_styled_components50.default.div`
    align-items: center;
    margin: 0 auto;
    width: 70.4rem;
    display: flex;
...
`, Img = import_styled_components50.default.img`
    display: block;
    height: 12.5rem;
    margin-bottom: 5rem;
    max-width: 100%
`, Title = import_styled_components50.default.h2`
    font-size: 4rem;
    font-weight: bold;
    line-height: 1.25;
    text-align: center;
    margin: 0 0 5rem 0;
`, SLink = (0, import_styled_components50.default)(import_react90.Link)`
    color: #fff;
    background-color: var(--color-secondary);
    border-radius: 5px;
    font-size: 1.6rem;
...
// app/routes/$.jsx
function NotFound() {
  return /* @__PURE__ */ import_react91.default.createElement("div", null, /* @__PURE__ */ import_react91.default.createElement(BackgroundDiv, null), /* @__PURE__ */ import_react91.default.createElement(MainDiv, null, /* @__PURE__ */ import_react91.default.createElement(Container6, null, /* @__PURE__ */ import_react91.default.createElement(Img, {
    src: __default,
    alt: "404"
  }), /* @__PURE__ */ import_react91.default.createElement(Title, null, "Sorry! The page you were looking for doesn\u2019t exist."), /* @__PURE__ */ import_react91.default.createElement(SLink, {
    to: "/"
  }, "Go back"))));
}
...
function Admin() {
  let {
    ...
    currentPage,
    size
  } = (0, import_react93.useLoaderData)(), [, setSearchParams] = (0, import_react93.useSearchParams)();
  return /* @__PURE__ */ import_react92.default.createElement("div", null, /* @__PURE__ */ import_react92.default.createElement(Notifications_default, null), /* @__PURE__ */ import_react92.default.createElement(Container4, null, /* @__PURE__ */ import_react92.default.createElement("h2", null, "Admin page"), /* @__PURE__ */ import_react92.default.createElement(UserSearchBar, {
    onSearch: (search2) => {
      setSearchParams({
        search: search2
      });
    }
  })), /* @__PURE__ */ import_react92.default.createElement(AdminUsersTable_default, {
    users,
    currentPage,
    totalPages,
    size
...
function CatchBoundary() {
  return /* @__PURE__ */ import_react92.default.createElement(__default2, null);
}
...
init_react();
var import_node10 = require("@remix-run/node"), import_react105 = require("@remix-run/react"), import_react106 = __toESM(require("react"));

// app/styles/Home.Styled.jsx
init_react();
var import_styled_components51 = __toESM(require("styled-components")), Container7 = import_styled_components51.default.div`
background-color: #f4f7f9;
`;
...
init_react();
var import_react103 = __toESM(require("react")), import_react104 = require("@remix-run/react"), import_prop_types57 = __toESM(require("prop-types"));

// app/components/ListQuestions/ListQuestions.Styled.jsx
init_react();
var import_react94 = require("@remix-run/react"), import_styled_components52 = __toESM(require("styled-components")), Container8 = import_styled_components52.default.div`
  display: flex;
  background-color: #f4f7f9;
  margin: 0 auto;
  width: 100%;
...
`, LeftWrapper = import_styled_components52.default.div`
  flex: 1;
`, CenterWrapper = import_styled_components52.default.div`
  flex: 2;
  display: flex;
  justify-content: center;
`, RightWrapper2 = import_styled_components52.default.div`
  flex: 1;
  display: flex;
  @media (max-width: 1025px) {
    width: 100%;
...
`, SloganWrapper = import_styled_components52.default.div`
  max-width: 425px;
  
  @media (max-width: 1025px) {
    display: none;
  }
`, QuestionsWrapper = import_styled_components52.default.div`
  max-width: 650px;
  width: 100%;
`, AskQuestionButtonWrapper = import_styled_components52.default.div`
  padding-right: 10px;
  padding-left: 10px;
  flex-direction: row;
  display: flex;
  justify-content: space-between;
  margin-bottom: 20px;
`, QuestionsTitle = import_styled_components52.default.div`
  align-items: center;
  display: flex;
  font-family: "Nunito", sans-serif;
  font-size: 20px;
  letter-spacing: 0.6px;
`, QuestionList = import_styled_components52.default.div`
  margin: 5px 0 10px;
  padding-left: 0;
`, Alert3 = import_styled_components52.default.div`
  border-radius: 3px;
  margin: 0 auto;
  max-width: 592px;
  width: 94%;
...
`, FiltersWrapper = import_styled_components52.default.div`
  width: 100%;
  max-width: 300px;
...
`, AskButton = (0, import_styled_components52.default)(import_react94.Link)`
  align-items: center;
  background: var(--color-secondary);
...
init_react();
var import_react95 = __toESM(require("react")), import_prop_types52 = __toESM(require("prop-types")), import_react_router_dom3 = require("react-router-dom");
...
function QuestionCard(props) {
  let {
    ...
    return /* @__PURE__ */ import_react95.default.createElement(CounterButtonsWrapper, {
      isAdmin: !1,
      hasAnswer
    }, /* @__PURE__ */ import_react95.default.createElement(CounterButton_default, {
    ...
    if (commentAsAnswer)
      return /* @__PURE__ */ import_react95.default.createElement(AnswerRow_default, {
  ...
  return /* @__PURE__ */ import_react95.default.createElement(QuestionCardContainer, null, /* @__PURE__ */ import_react95.default.createElement(QuestionCardWrapper, null, /* @__PURE__ */ import_react95.default.createElement(QuestionCardBorder, null, /* @__PURE__ */ import_react95.default.createElement(QuestionRow_default, {
    question,
    isQuestionModalOpen: !1,
    hasAnswer
  }), /* @__PURE__ */ import_react95.default.createElement(QuestionCardActions, {
    hasAnswer,
    isQuestionModalOpen: !1
...
init_react();
var import_styled_components53 = __toESM(require("styled-components")), Button3 = import_styled_components53.default.button`
  all: unset;
  align-items: center;
  background-color: var(--color-secondary);
...
`, Span = import_styled_components53.default.span`
  color: #ffffff;
  font-family: 'Nunito', sans-serif;
  font-size: 14px;
  font-weight: 600;
...
function ArrowIcon(props) {
  return /* @__PURE__ */ import_react96.default.createElement("svg", __spreadValues({
    color: "white",
    fill: "currentColor",
    fillRule: "nonzero",
    height: 12,
...
function GoToTopButton() {
  let [show, setShow] = (0, import_react97.useState)(!1);
  return (0, import_react97.useEffect)(() => {
    window.addEventListener("scroll", () => {
      window.scrollY > 500 ? setShow(!0) : setShow(!1);
    });
  }, []), /* @__PURE__ */ import_react97.default.createElement(Button3, {
    id: "go-to-top-button",
    display: show,
    onClick: () => {
      window.scrollTo({
  ...
  }, /* @__PURE__ */ import_react97.default.createElement(ArrowIcon_default, null), /* @__PURE__ */ import_react97.default.createElement(Span, null, BACK_TO_TOP));
}
...
init_react();
var import_react98 = __toESM(require("react")), import_prop_types53 = __toESM(require("prop-types"));
function InfiniteScrollList({ onFetch, children }) {
  let endOfListRef = (0, import_react98.useRef)(), scrollContainer = null, fetchScrollLimit = 500, onScroll = ([entity]) => {
    entity.isIntersecting && onFetch();
  }, observer = (0, import_react98.useRef)();
  return (0, import_react98.useEffect)(() => (observer.current = new IntersectionObserver(onScroll, {
  ...
  }), [children.props.children.length]), /* @__PURE__ */ import_react98.default.createElement("div", null, children, /* @__PURE__ */ import_react98.default.createElement("div", {
    ref: endOfListRef
  }));
}
...
init_react();
var import_react100 = __toESM(require("react")), import_prop_types55 = __toESM(require("prop-types")), import_react101 = require("@remix-run/react");
...
init_react();
var import_styled_components54 = __toESM(require("styled-components")), Filters = import_styled_components54.default.div`
  background-color: transparent;
  margin: 0 11px;
  position: -webkit-sticky;
  position: sticky;
...
`, Icon = import_styled_components54.default.img`
  height: 20px;
  margin-right: 10px;
  width: 17px;
`, FiltersLine = import_styled_components54.default.hr`
  border-top: 1px solid #e6e6e6;
  margin: 16px 0 24px;
  display: ${(props) => props.visibility};
  ${(props) => props.secondary && import_styled_components54.css`
    margin: 0;
  `}
...
`, FiltersWrapper2 = import_styled_components54.default.div`
  flex-grow: 1;
...
`, FiltersContainer = import_styled_components54.default.div`
  display: unset;
`, FiltersBlock = import_styled_components54.default.div``, FiltersLabel = import_styled_components54.default.div`
  font-size: 12px;
  margin: 8px 0 4px;
  width: auto;
  button {
...
`, FiltersField = import_styled_components54.default.div`
  ...
  ${(props) => props.departments && import_styled_components54.css`
...
init_react();
var import_react99 = __toESM(require("react")), import_prop_types54 = __toESM(require("prop-types"));

// app/components/CustomDropdown/CustomDropdown.Styled.jsx
init_react();
var import_styled_components55 = __toESM(require("styled-components")), import_react_bootstrap12 = require("react-bootstrap"), CDropdown = (0, import_styled_components55.default)(import_react_bootstrap12.Dropdown)`
  .dropdown-menu {
    top: 98%;
    background-color: transparent;
  }
...
`, CDropdownText = import_styled_components55.default.p`
  color: var(--color-secondary);
  float: left;
  font-size: 12px;
  padding-left: 5px;
...
`, CMenuItem = (0, import_styled_components55.default)(import_react_bootstrap12.MenuItem)`
  .custom-dropdown {
    cursor: pointer;
    display: block;
    font-size: 14px;
...
function CustomDropdown(props) {
  let { accessValueName, selectedValue } = props, renderElements = (elements) => elements.map((element) => /* @__PURE__ */ import_react99.default.createElement(CMenuItem, {
    eventKey: element,
    key: element[accessValueName]
  }, /* @__PURE__ */ import_react99.default.createElement("label", {
    className: "custom-dropdown",
    htmlFor: element[accessValueName]
  }, element.name, /* @__PURE__ */ import_react99.default.createElement("input", {
    type: "radio",
  ...
  })))), renderSelected = () => props.showSelected && /* @__PURE__ */ import_react99.default.createElement("p", {
    className: "custom-dropdown-selected"
  }, props.text);
  return /* @__PURE__ */ import_react99.default.createElement(CDropdown, {
    className: props.dropdownClass,
    onSelect: props.onSelectFunc,
    id: props.dropdownClass,
    disabled: props.disabled
  }, /* @__PURE__ */ import_react99.default.createElement(CDropdown.Toggle, {
    onClick: props.onClickFunc,
    className: `toggle ${props.isHighlighted ? "highlighted" : ""}`
  }, /* @__PURE__ */ import_react99.default.createElement("p", {
    className: `dropdown-text ${props.showSelected ? "" : "first"}`
  }, props.label), renderSelected()), /* @__PURE__ */ import_react99.default.createElement(CDropdown.Menu, {
...
function Filters2(props) {
  let { modifyQuery, clearFilters } = props, { departments, locations } = (0, import_react101.useLoaderData)(), [searchParams] = (0, import_react101.useSearchParams)(), getDefaultStatus = () => {
  ...
  }, [selectedOrderBy, setSelectedOrderBy] = (0, import_react100.useState)(getDefaultSortOption()), [selectedDateRange, setSelectedDateRange] = (0, import_react100.useState)(getDefaultDateRangeOption()), [selectedStatus, setSelectedStatus] = (0, import_react100.useState)(getDefaultStatus()), [selectedDepartment, setSelectedDepartment] = (0, import_react100.useState)(getDefaultDepartmentOption()), [selectedLocation, setSelectedLocation] = (0, import_react100.useState)(getDefaultLocationOption()), [showClearButton, setShowClearButton] = (0, import_react100.useState)(!1), [showFilters, setShowFilters] = (0, import_react100.useState)(!1), [filtersButtonName, setFiltersButtonName] = (0, import_react100.useState)("Show filters");
  ...
  return /* @__PURE__ */ import_react100.default.createElement(Filters, null, /* @__PURE__ */ import_react100.default.createElement(Button_default, {
    type: "button",
    category: TEXT_BUTTON,
    ...
    alt: "Icon"
  }), /* @__PURE__ */ import_react100.default.createElement("span", null, filtersButtonName)), /* @__PURE__ */ import_react100.default.createElement(FiltersLine, {
    secondary: !0,
    visibility: "none"
  }), /* @__PURE__ */ import_react100.default.createElement(FiltersWrapper2, {
    hideComponent: showFilters ? "block" : "none"
  }, /* @__PURE__ */ import_react100.default.createElement(FiltersContainer, null, /* @__PURE__ */ import_react100.default.createElement(FiltersBlock, null, /* @__PURE__ */ import_react100.default.createElement(FiltersLabel, null, "Order by:"), /* @__PURE__ */ import_react100.default.createElement(FiltersField, null, /* @__PURE__ */ import_react100.default.createElement(CustomDropdown_default, __spreadValues({}, orderByDropdownConfig)))), /* @__PURE__ */ import_react100.default.createElement(FiltersBlock, null, /* @__PURE__ */ import_react100.default.createElement(FiltersLabel, null, "Filter by:", " ", showClearButton && /* @__PURE__ */ import_react100.default.createElement("button", {
    type: "button",
    onClick: clearAllFilters
  }, "Clear All Filters")), /* @__PURE__ */ import_react100.default.createElement(FiltersField, null, /* @__PURE__ */ import_react100.default.createElement(CustomDropdown_default, __spreadValues({}, dateRangeFilterConfig))), /* @__PURE__ */ import_react100.default.createElement(FiltersField, null, /* @__PURE__ */ import_react100.default.createElement(CustomDropdown_default, __spreadValues({}, statusFilterConfig))), /* @__PURE__ */ import_react100.default.createElement(FiltersField, {
    departments: !0
  }, /* @__PURE__ */ import_react100.default.createElement(CustomDropdown_default, __spreadValues({}, departmentFilterConfig))), /* @__PURE__ */ import_react100.default.createElement(FiltersField, null, /* @__PURE__ */ import_react100.default.createElement(CustomDropdown_default, __spreadValues({}, getLocationFilterConfig())))))));
}
Filters2.propTypes = {
...
init_react();
var import_styled_components56 = __toESM(require("styled-components")), Modal4 = import_styled_components56.default.div`
    position: fixed;
    top: 0;
    left: 0;
    right: 0;
    ...
    align-items: center;
    background-color: rgba(0, 0, 0, 0.5);
`, ModalDialog4 = import_styled_components56.default.div`
    position: relative;
    border-radius: 5px;
    border: 0;
    background-color: #fff;
...
`, ModalBody5 = import_styled_components56.default.div`
    display: block;
    font-size: 15px;
    background-color: #fff;
    border-bottom: none;
    ...
    box-sizing: border-box;
    text-align: justify;
`, ModalFooter6 = import_styled_components56.default.div`
    border-top: none;
    background-color: #fff;
    border-bottom: none;
    padding: 15px;
...
`, ModalHeader6 = import_styled_components56.default.div`
    overflow-y: hidden;
    padding: 15px;
    box-sizing: border-box;
    display: block;
...
`, ModalTitle5 = import_styled_components56.default.div`
    font-size: 16px;
    font-weight: 600;
    line-height: normal;
    letter-spacing: normal;
    margin-bottom: 8px;
`, ModalSubtitle3 = import_styled_components56.default.div`
    font-size: 16px;
    font-weight: normal;
    letter-spacing: 0.6px;
    line-height: 1.71;
`, ValueText = import_styled_components56.default.span`
    color: ${(props) => props.color};
    font-weight: 600;
    font-size: 16px;
    text-decoration:  ${(props) => props.color} underline overline;
`, ValuesInformation = import_styled_components56.default.div`
...
function ValuesMessageModal({ show, onClose }) {
  let profile = useUser_default(), renderBulletPoint = (color2) => /* @__PURE__ */ import_react102.default.createElement(import_bs6.BsCircleFill, {
    color: color2,
    size: "7px",
    style: { marginTop: "3px", marginRight: "10px" }
  });
  return show ? /* @__PURE__ */ import_react102.default.createElement("div", {
    onClick: onClose
  }, /* @__PURE__ */ import_react102.default.createElement(Modal4, {
    onClick: onClose
  }, /* @__PURE__ */ import_react102.default.createElement(ModalDialog4, {
    show: !0,
    hide: onClose
  }, /* @__PURE__ */ import_react102.default.createElement(ModalHeader6, null, /* @__PURE__ */ import_react102.default.createElement(ModalTitle5, null, "Hello", " ", profile.full_name, " ", "!"), /* @__PURE__ */ import_react102.default.createElement(ModalSubtitle3, null, "Welcome to Wize Q!")), /* @__PURE__ */ import_react102.default.createElement(ModalBody5, null, /* @__PURE__ */ import_react102.default.createElement("p", null, "We want to share a few simple guidelines before you start. Remember that Wize Q is a space for asking questions and providing answers that are helpful to our community."), /* @__PURE__ */ import_react102.default.createElement("p", null, "Please practice our values when using Wize Q: "), /* @__PURE__ */ import_react102.default.createElement(ValuesInformation, null, /* @__PURE__ */ import_react102.default.createElement("p", null, renderBulletPoint("var(--color-primary)"), /* @__PURE__ */ import_react102.default.createElement(ValueText, {
    color: "var(--color-primary)"
  }, "Ownership"), "\u2013 See if you can find the answer to your question before posting on Wize Q. And if you know the answer to a question or how to find it, be sure to reply \u2014 anyone can!"), /* @__PURE__ */ import_react102.default.createElement("p", null, renderBulletPoint("var(--color-secondary)"), /* @__PURE__ */ import_react102.default.createElement(ValueText, {
    color: "var(--color-secondary)"
  }, "Innovation"), "\u2013 When someone shares a concern or challenge, let\u2019s be innovative \u2014 propose a solution or offer support!"), /* @__PURE__ */ import_react102.default.createElement("p", null, renderBulletPoint("#E5C8A6"), /* @__PURE__ */ import_react102.default.createElement(ValueText, {
    color: "#E5C8A6"
  }, "Community"), "\u2013 Remember to treat everyone with dignity and respect. Assume others have good intentions. Always be honest and constructive. Let\u2019s make Wizeline a community where everyone can thrive.")), /* @__PURE__ */ import_react102.default.createElement("p", null, "Consider that other channels: (ticketing portal, Slack, your manager or people partner) might be more effective for finding the right answer quickly."), /* @__PURE__ */ import_react102.default.createElement("p", null, "Thanks for being a valuable contributor to our community! "), /* @__PURE__ */ import_react102.default.createElement("p", null, "The Wize Q Team")), /* @__PURE__ */ import_react102.default.createElement(ModalFooter6, null, /* @__PURE__ */ import_react102.default.createElement(Button_default, {
    id: "btnAccept",
    category: SECONDARY_BUTTON,
    onClick: onClose
  }, "Accept"))))) : null;
...
function ListQuestions({
  ...
  let submit = (0, import_react104.useSubmit)(), transition = (0, import_react104.useTransition)(), voteQuestionForm = (0, import_react103.useRef)(), profile = useUser_default(), [showValuesMessage, setShowValueMessage] = (0, import_react103.useState)(getCookie("showValueMessage")), [searchParams, setSearchParams] = (0, import_react104.useSearchParams)(), [title, setTitle] = (0, import_react103.useState)("Newest Questions"), valuesMessageModal = showValuesMessage === "true" && /* @__PURE__ */ import_react103.default.createElement(ValuesMessageModal_default, {
    ...
    return questions.length === 0 ? null : questions.map((question, index2) => /* @__PURE__ */ import_react103.default.createElement(QuestionCard_default, {
      key: question.question_id,
  ...
  return /* @__PURE__ */ import_react103.default.createElement(Container8, null, /* @__PURE__ */ import_react103.default.createElement(LeftWrapper, null, /* @__PURE__ */ import_react103.default.createElement(SloganWrapper, null, /* @__PURE__ */ import_react103.default.createElement(Slogan_default, null))), /* @__PURE__ */ import_react103.default.createElement(CenterWrapper, null, /* @__PURE__ */ import_react103.default.createElement(QuestionsWrapper, null, /* @__PURE__ */ import_react103.default.createElement(AskQuestionButtonWrapper, null, /* @__PURE__ */ import_react103.default.createElement(QuestionsTitle, null, title), (() => /* @__PURE__ */ import_react103.default.createElement(AskButton, {
    to: "/questions/new",
    id: "ask-button"
  }, "Ask Question"))()), questions.length === 0 ? /* @__PURE__ */ import_react103.default.createElement(Alert3, null, renderNoResultMessage()) : /* @__PURE__ */ import_react103.default.createElement(InfiniteScrollList_default, {
    onFetch: onFetchMore
  }, /* @__PURE__ */ import_react103.default.createElement(QuestionList, {
    id: "questions-list"
  }, renderQuestionsList(questions))))), /* @__PURE__ */ import_react103.default.createElement(RightWrapper2, null, /* @__PURE__ */ import_react103.default.createElement(FiltersWrapper, null, /* @__PURE__ */ import_react103.default.createElement(Filters_default, {
    modifyQuery,
    clearFilters
  }))), /* @__PURE__ */ import_react103.default.createElement(GoToTopButton_default, null), valuesMessageModal);
}
...
function Index() {
  let { questions: initialQuestions } = (0, import_react105.useLoaderData)(), [questions, setQuestions] = (0, import_react106.useState)(initialQuestions), fetcher = (0, import_react105.useFetcher)(), [shouldFetch, setShouldFetch] = (0, import_react106.useState)(!0), [page, setPage] = (0, import_react106.useState)(2), [searchParams] = (0, import_react105.useSearchParams)(), onFetchMore = () => {
  ...
  }, [fetcher.data]), (0, import_react106.useEffect)(() => {
    setQuestions(initialQuestions), setPage(2), setShouldFetch(!0);
  }, [initialQuestions, searchParams]), /* @__PURE__ */ import_react106.default.createElement(import_react106.default.Fragment, null, /* @__PURE__ */ import_react106.default.createElement(Notifications_default, null), /* @__PURE__ */ import_react106.default.createElement(Container7, null, /* @__PURE__ */ import_react106.default.createElement(ListQuestions_default, {
    type: "all",
    questions,
    onFetchMore
  })));
...
init_react();
var import_react109 = __toESM(require("react")), import_node11 = require("@remix-run/node");
...
var LoginDiv = import_styled_components57.default.div`
  position: absolute;
  width: 100%;
  height: 100%;
  display: flex;
  ...
  justify-content: center;
  align-items: center;
`, LoginSubDiv = import_styled_components57.default.div`
  display: flex;
  width: 100%;
  height: 100%;
...
`, SH3 = import_styled_components57.default.h3`
  text-align: center;
  color: #646464;
  margin-bottom: 50px;
  font-family: "Nunito";
  ...
  letter-spacing: 0.4px;
  font-weight: 700;
`, Span2 = import_styled_components57.default.span`
  ${(props) => (props.variant === "bold", 'font-family: "Nunito";')}
`, Paragraph = import_styled_components57.default.p`
  text-align: center;
  color: #646464;
  font-family: "Nunito";
  font-size: 18px;
  ...
  margin-top: 50px;
  width: 350px;
`, LeftDiv = import_styled_components57.default.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
...
`, RightDiv = import_styled_components57.default.div`
  display: flex;
  width: 55%;
  align-items: center;
  justify-content: center;
...
`, Slogan2 = import_styled_components57.default.div`
  width: 320px;
...
`, RedDiv = import_styled_components57.default.div`
  width: 20px;
  background-color: var(--color-primary);
  position: absolute;
  height: 100%;
  left: 0;
`, GoldDiv = import_styled_components57.default.div`
  width: 20px;
  background-color: #e5c8a6;
  position: absolute;
  height: 100%;
  left: 20px;
`, AdviceContainer = import_styled_components57.default.div`
  color: white;
  font-size: 15px;
...
function LoginContainer() {
  ...
  }, []), /* @__PURE__ */ import_react107.default.createElement(LoginDiv, null, /* @__PURE__ */ import_react107.default.createElement(LoginSubDiv, null, /* @__PURE__ */ import_react107.default.createElement(LeftDiv, null, /* @__PURE__ */ import_react107.default.createElement(SH3, null, "Welcome Wizeliner!"), /* @__PURE__ */ import_react107.default.createElement(import_react108.Form, {
    action: "/auth/auth0",
    method: "POST"
  }, /* @__PURE__ */ import_react107.default.createElement("input", {
    type: "hidden",
    name: "redirectTo",
    value: redirectTo
  ...
  }, "Log in with your Wizeline account")), /* @__PURE__ */ import_react107.default.createElement(Paragraph, null, /* @__PURE__ */ import_react107.default.createElement(Span2, null, "Wizeline Questions"), /* @__PURE__ */ import_react107.default.createElement(Span2, {
    variant: "bold"
  }, " DOES NOT "), /* @__PURE__ */ import_react107.default.createElement(Span2, null, "store any personal information so that you can ask anything."))), /* @__PURE__ */ import_react107.default.createElement(RightDiv, null, /* @__PURE__ */ import_react107.default.createElement(RedDiv, null), /* @__PURE__ */ import_react107.default.createElement(GoldDiv, null), /* @__PURE__ */ import_react107.default.createElement("img", {
    src: logo_white_default,
    alt: "logo"
  }), /* @__PURE__ */ import_react107.default.createElement(Slogan2, null, /* @__PURE__ */ import_react107.default.createElement(Slogan_default, null), /* @__PURE__ */ import_react107.default.createElement(AdviceContainer, null, /* @__PURE__ */ import_react107.default.createElement("p", null, "Before asking a question verify if you can get the information you need from these resources."), /* @__PURE__ */ import_react107.default.createElement("ul", null, /* @__PURE__ */ import_react107.default.createElement("li", null, /* @__PURE__ */ import_react107.default.createElement("a", {
    href: "https://wizeline.slack.com/archives/C1UDJCL9E"
  }, " #Questions "), "- Slack Channel"), /* @__PURE__ */ import_react107.default.createElement("li", null, /* @__PURE__ */ import_react107.default.createElement("a", {
...
function Login() {
  return /* @__PURE__ */ import_react109.default.createElement(LoginContainer_default, null);
}
...
init_react();
var import_react110 = __toESM(require("react")), import_node12 = require("@remix-run/node");
var loader13 = async ({ request }) => (await requireAuth(request), (0, import_node12.json)({}));
function About3() {
  return /* @__PURE__ */ import_react110.default.createElement(About, null, /* @__PURE__ */ import_react110.default.createElement(AboutBody, null, /* @__PURE__ */ import_react110.default.createElement("h1", null, "TESTING"), /* @__PURE__ */ import_react110.default.createElement("h2", null, "This is Wizeline Questions"), /* @__PURE__ */ import_react110.default.createElement("p", null, /* @__PURE__ */ import_react110.default.createElement("strong", null, "Wizeline Questions (WizeQ)"), " ", "is a communication space where you can express your ideas, learn more about Wizeline, and ask all kinds of questions."), /* @__PURE__ */ import_react110.default.createElement("p", null, "Wizeline Questions is a knowledge base where you can ask for information to a specific department and allow other Wizeliners to benefit from it. For example:"), /* @__PURE__ */ import_react110.default.createElement(BoxWrapper, null, /* @__PURE__ */ import_react110.default.createElement(BoxContainer, null, /* @__PURE__ */ import_react110.default.createElement(BoxImageContainer, null, /* @__PURE__ */ import_react110.default.createElement(BoxImage, {
    src: ic_meeting_default
  }), /* @__PURE__ */ import_react110.default.createElement(BoxBoldText, null, "Are you still having problems with Zoom for your next meeting?")), /* @__PURE__ */ import_react110.default.createElement(BoxMetadata, null, "Check Wizeline Questions, someone might have already asked IT the same question. If that is not the case, this is your chance to shine!")), /* @__PURE__ */ import_react110.default.createElement(BoxContainer, null, /* @__PURE__ */ import_react110.default.createElement(BoxImageContainer, null, /* @__PURE__ */ import_react110.default.createElement(BoxImage, {
    src: ic_saving_fund_default
  }), /* @__PURE__ */ import_react110.default.createElement(BoxBoldText, null, "Do you want to know more about the savings fund?")), /* @__PURE__ */ import_react110.default.createElement(BoxMetadata, null, "Tag People Ops in your question, other Wizeliners will be glad to learn about that same topic, for sure!"))), /* @__PURE__ */ import_react110.default.createElement(AboutMetadata, null, /* @__PURE__ */ import_react110.default.createElement("p", null, "Information can be easily lost in the flood of comments and pinged posts on Slack. Do you need information to persist?", " ", /* @__PURE__ */ import_react110.default.createElement("strong", null, "Use Wizeline Questions instead!"))), /* @__PURE__ */ import_react110.default.createElement("h3", null, "What else?"), /* @__PURE__ */ import_react110.default.createElement(AboutWhatElseContainer, null, /* @__PURE__ */ import_react110.default.createElement(AboutWhatElseImg, {
    src: ic_dialogue_default
  }), /* @__PURE__ */ import_react110.default.createElement(AboutWHatElseText, null, /* @__PURE__ */ import_react110.default.createElement(AboutWHatElseBold, null, "Start a conversation. Is there a topic you want to discuss with other Wizeliners?"), /* @__PURE__ */ import_react110.default.createElement(AboutWhatElseMetadata, null, "This is the place!. You can reply to a question and also hold interesting conversations with other Wizeliners.  Use it as a discussion forum, suggestion what-else, or simply visit to say hello! Help us to keep Wizeline an amazing place!"))), /* @__PURE__ */ import_react110.default.createElement(AboutWhatElseContainer, null, /* @__PURE__ */ import_react110.default.createElement(AboutWhatElseImg, {
    src: ic_anonymous_default
  }), /* @__PURE__ */ import_react110.default.createElement(AboutWHatElseText, null, /* @__PURE__ */ import_react110.default.createElement(AboutWHatElseBold, null, "Is there a sensitive question you want to ask anonymously?"), /* @__PURE__ */ import_react110.default.createElement(AboutWhatElseMetadata, null, "Ask on Wizeline Questions! To promote ownership and open communication, it displays your user name by default when you post a new question. But you can always opt for anonymity."))), /* @__PURE__ */ import_react110.default.createElement("h3", null, "Things to Keep in Mind When Asking a Question"), /* @__PURE__ */ import_react110.default.createElement("span", null, /* @__PURE__ */ import_react110.default.createElement("p", null, "We value your ideas, questions, suggestions, and comments. Therefore, we encourage you to use this communication space. Please, when writing a new question or a comment follow these recommendations:"), /* @__PURE__ */ import_react110.default.createElement("div", {
    style: { textAlign: "justify" }
  }, /* @__PURE__ */ import_react110.default.createElement("ul", null, /* @__PURE__ */ import_react110.default.createElement("li", null, "Strive for constructive open communication. Avoid vagueness."), /* @__PURE__ */ import_react110.default.createElement("li", null, "Do not demean or degrade others because of their gender, race, age, religion, etc."), /* @__PURE__ */ import_react110.default.createElement("li", null, "Avoid posting questions that include sexually explicit comments, hate speech, prejudicial remarks, and profanity."), /* @__PURE__ */ import_react110.default.createElement("li", null, "Do not mock other members, their comments, profiles, threads, or experiences. Remember, what is funny for you may be offensive to others."))))), /* @__PURE__ */ import_react110.default.createElement(AboutFooter, null, /* @__PURE__ */ import_react110.default.createElement("p", null, /* @__PURE__ */ import_react110.default.createElement("strong", null, "We need your help!"), " ", "Wizeline Questions is an internal project and everyone can contribute. Come aboard and meet the team at", /* @__PURE__ */ import_react110.default.createElement("a", {
    href: "https://wizeline.slack.com/archives/C031D9DP7C2",
    target: "_blank",
    rel: "noopener noreferrer"
  }, "#wize-q-2022"), ". You can take a look at our", /* @__PURE__ */ import_react110.default.createElement("a", {
    href: "https://github.com/wizeline/wize-q-remix"
  }, "source code"), " ", "on GitHub.")));
}
var test_default = About3;

// server-assets-manifest:@remix-run/dev/assets-manifest
init_react();
var assets_manifest_default = { version: "738df41b", entry: { module: "/build/entry.client-WVOK65CE.js", imports: ["/build/_shared/chunk-IT4B5LWP.js", "/build/_shared/chunk-CA4B4QDL.js", "/build/_shared/chunk-3WZ3CGWF.js"] }, routes: { root: { id: "root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/root-V764PQEZ.js", imports: ["/build/_shared/chunk-UK7JQ2MH.js", "/build/_shared/chunk-CHRNTAPK.js", "/build/_shared/chunk-5M22U5RX.js", "/build/_shared/chunk-NG3NZK5E.js", "/build/_shared/chunk-HZDGKNSJ.js", "/build/_shared/chunk-HVOR6U45.js", "/build/_shared/chunk-U2RNYPEX.js", "/build/_shared/chunk-P7BYWKM6.js", "/build/_shared/chunk-UBEID7IU.js", "/build/_shared/chunk-VKNNRTVS.js", "/build/_shared/chunk-DTXDYIFC.js", "/build/_shared/chunk-UPCFJQSK.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !0 }, "routes/$": { id: "routes/$", parentId: "root", path: "*", index: void 0, caseSensitive: void 0, module: "/build/routes/$-LV76AEPG.js", imports: ["/build/_shared/chunk-ZJYHTA2X.js"], hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/about": { id: "routes/about", parentId: "root", path: "about", index: void 0, caseSensitive: void 0, module: "/build/routes/about-GKUKDHPZ.js", imports: ["/build/_shared/chunk-6LNKIHJP.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/admin": { id: "routes/admin", parentId: "root", path: "admin", index: void 0, caseSensitive: void 0, module: "/build/routes/admin-4XODS2UL.js", imports: ["/build/_shared/chunk-ZJYHTA2X.js", "/build/_shared/chunk-RPQVA7VX.js", "/build/_shared/chunk-5V57YOE4.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !0, hasErrorBoundary: !1 }, "routes/auth/auth0": { id: "routes/auth/auth0", parentId: "root", path: "auth/auth0", index: void 0, caseSensitive: void 0, module: "/build/routes/auth/auth0-KBQ2S7BZ.js", imports: void 0, hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/auth/auth0/callback": { id: "routes/auth/auth0/callback", parentId: "routes/auth/auth0", path: "callback", index: void 0, caseSensitive: void 0, module: "/build/routes/auth/auth0/callback-CN5UOKJC.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/contact": { id: "routes/contact", parentId: "root", path: "contact", index: void 0, caseSensitive: void 0, module: "/build/routes/contact-4NI7WJSS.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/employees/getByDeparment/$id": { id: "routes/employees/getByDeparment/$id", parentId: "root", path: "employees/getByDeparment/:id", index: void 0, caseSensitive: void 0, module: "/build/routes/employees/getByDeparment/$id-BTD55P6L.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/index": { id: "routes/index", parentId: "root", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/index-MIMKCUK2.js", imports: ["/build/_shared/chunk-J3GNERB6.js", "/build/_shared/chunk-L7GAI6VS.js", "/build/_shared/chunk-RVRN3YQ7.js", "/build/_shared/chunk-DKUFPYEM.js", "/build/_shared/chunk-5V57YOE4.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/login": { id: "routes/login", parentId: "root", path: "login", index: void 0, caseSensitive: void 0, module: "/build/routes/login-M2ATOCNO.js", imports: ["/build/_shared/chunk-J3GNERB6.js", "/build/_shared/chunk-RVRN3YQ7.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/logout": { id: "routes/logout", parentId: "root", path: "logout", index: void 0, caseSensitive: void 0, module: "/build/routes/logout-4LBXPPXN.js", imports: void 0, hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/questions/$questionId": { id: "routes/questions/$questionId", parentId: "root", path: "questions/:questionId", index: void 0, caseSensitive: void 0, module: "/build/routes/questions/$questionId-6KWVSX2I.js", imports: ["/build/_shared/chunk-RPQVA7VX.js", "/build/_shared/chunk-L7GAI6VS.js", "/build/_shared/chunk-LBDFOG4Y.js", "/build/_shared/chunk-DKUFPYEM.js", "/build/_shared/chunk-5V57YOE4.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/questions/new": { id: "routes/questions/new", parentId: "root", path: "questions/new", index: void 0, caseSensitive: void 0, module: "/build/routes/questions/new-5WQ4IAGG.js", imports: ["/build/_shared/chunk-RVRN3YQ7.js", "/build/_shared/chunk-LBDFOG4Y.js", "/build/_shared/chunk-DKUFPYEM.js", "/build/_shared/chunk-5V57YOE4.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/test": { id: "routes/test", parentId: "root", path: "test", index: void 0, caseSensitive: void 0, module: "/build/routes/test-3NNGWZDE.js", imports: ["/build/_shared/chunk-6LNKIHJP.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 } }, url: "/build/manifest-738DF41B.js" };
