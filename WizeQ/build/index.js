...
`, Input3 = import_styled_components44.default.input`
    ...
    border: none;
    outline: none;
`, Button3 = import_styled_components44.default.button`
    width: 30px;
    height: 30px;
    border-radius: 25%;
    background-color: #fff;
...
init_react();
var pdfConv = async (conversation) => (console.log(conversation), fetch("http://127.0.0.1:3000/api/pdf_conversation_gpt", {
  method: "POST",
  body: JSON.stringify(conversation),
  headers: {
    "Content-Type": "application/json"
  }
}).then((response) => response.json()).then((data) => ({ text: data[data.length - 1].content })).catch((error) => console.error(error)));

// app/controllers/answerBot/getAllAnswers.js
init_react();
var allAnswers = (questions) => {
  let questionsAnswered = [];
  return questions.map((question) => {
    question.Answers = question.Answers ?? [], question.Answers.length > 0 && questionsAnswered.push([question.question, question.Answers[0].answer_text]), question.hasCommentApproved == !0 && question.Comments.map((comment) => {
      comment.Approver != null && questionsAnswered.push([question.question, comment.comment]);
    });
  }), questionsAnswered;
};
...
function AnswerBotButton() {
  let instructions = `Context: The prompt has 3 sections. Starting with 'search results' having info gathered from documents that can aid us in answering the prompt.
The second section is 'Answers' that hold trusted answers given by admins to questions already answered.
The final section is 'Query' which is the question that must be replied to, given by the user.

Instructions: 
 Compose a comprehensive reply to the query using the search results and answers given.
 If the search results mention multiple subjects
with the same name, create separate answers for each. Only include information found within the prompt, be confident in the deliver. Make sure the answer is correct and don't output false content.
If the text does not relate to the query, simply state 'No se encontro respuesta'.
Don't write 'Answer:'Directly start the answer.

 'Answers': ['The sun sets at 8pm', 'No animals are allowed entry into the office installations']`, messagesEndRef = (0, import_react78.useRef)(null), [messages, setMessages] = (0, import_react78.useState)([{ role: "system", content: instructions }, { role: "system", content: "Hello! Ask me any question and I'll see how I can help you." }]), handleInput = async (e) => {
    e.preventDefault();
    let input = e.target.querySelector("input"), message = input.value;
    input.value = "", setMessages([...messages, { role: "user", content: message }]);
    let filteredMessages = [...messages, { role: "user", content: message }].filter((message2, index2) => index2 !== 1), response = await pdfConv(filteredMessages), answer = response.text;
    setMessages([...messages, { role: "user", content: message }, { role: "system", content: answer }]), console.log(response);
  };
  ...
  let [chatbotVisible, setChatbotVisible] = (0, import_react78.useState)(!1), handleChatbotToggle = () => {
    setChatbotVisible(!chatbotVisible), console.log(chatbotVisible);
  };
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(BotButton, {
    visible: !chatbotVisible,
    onClick: handleChatbotToggle
  }, /* @__PURE__ */ React.createElement(BotIcon, null), /* @__PURE__ */ React.createElement(BotMessage, {
    className: "message"
  }, "Hi, I'm AnswerBot!", /* @__PURE__ */ React.createElement("br", null), "Ask me anything!")), /* @__PURE__ */ React.createElement(ChatbotContainer, {
    visible: chatbotVisible
  }, /* @__PURE__ */ React.createElement(ChatbotHeader, null, /* @__PURE__ */ React.createElement(IconBot, {
    style: { position: "absolute" }
  }), /* @__PURE__ */ React.createElement(BotName, null, " AnswerBot "), /* @__PURE__ */ React.createElement(CloseButton2, {
    onClick: handleChatbotToggle
  }, " \u2715 ")), /* @__PURE__ */ React.createElement(ChatbotMessages, null, messages.slice(1).map((message, index2) => message.role == "user" ? /* @__PURE__ */ React.createElement(ChatbotRowMessage, {
    style: { justifyContent: "flex-end" }
  }, /* @__PURE__ */ React.createElement(Message, {
    key: index2,
    className: "user",
    ref: messagesEndRef
  }, " ", message.content, " "), /* @__PURE__ */ React.createElement(IconUser, {
    src: "/build/_assets/placeholder_user_img-ZWAQNLBE.png"
  })) : /* @__PURE__ */ React.createElement(ChatbotRowMessage, {
    style: { justifyContent: "flex-start" }
  }, /* @__PURE__ */ React.createElement(IconBot, null), /* @__PURE__ */ React.createElement(Message, {
    key: index2,
    className: "bot",
    ref: messagesEndRef
  }, " ", message.content, " ")))), /* @__PURE__ */ React.createElement(ChatbotInput, {
...
function CreateQuestion() {
  ...
  }, [chatbotVisible, setChatbotVisible] = (0, import_react79.useState)(!1), handleChatbotToggle = () => {
    setChatbotVisible(!chatbotVisible), console.log(chatbotVisible);
  };
...
var loader7 = async ({ request }) => (await requireAuth(request), (0, import_node6.json)({})), initialState = {
  ...
  let { full_name: name, email } = useUser_default(), [state, setState] = (0, import_react83.useState)(initialState), resetForm = () => {
    ...
    return /* @__PURE__ */ import_react83.default.createElement(ContactForm, {
      onSubmit
    }, /* @__PURE__ */ import_react83.default.createElement(ContactFormP, null, "Hi", /* @__PURE__ */ import_react83.default.createElement("strong", null, " ", firstName), "!", /* @__PURE__ */ import_react83.default.createElement("br", null), "Send us a message!"), /* @__PURE__ */ import_react83.default.createElement(ContactSelect, {
      name: "reason",
...
`, Input4 = import_styled_components46.default.input`
  ...
  border: none;
  outline: none;
`, Button4 = import_styled_components46.default.button`
  width: 30px;
  height: 30px;
  border-radius: 25%;
  background-color: #fff;
...
function Chatbot() {
  ...
  return /* @__PURE__ */ import_react84.default.createElement("div", null, /* @__PURE__ */ import_react84.default.createElement("button", {
    ...
    onClick: handleChatbotToggle
  }, " \u2715 ")), /* @__PURE__ */ import_react84.default.createElement(ChatbotMessages2, null, messages.map((message, index2) => message.user ? /* @__PURE__ */ import_react84.default.createElement(ChatbotRowMessage2, {
    style: { justifyContent: "flex-end" }
    ...
    type: "text",
    placeholder: "Enter your question..."
  }), /* @__PURE__ */ import_react84.default.createElement(Button4, {
    type: "submit"
  }))));
}
...
init_react();
var import_styled_components55 = __toESM(require("styled-components")), Button5 = import_styled_components55.default.button`
  all: unset;
  align-items: center;
  background-color: var(--color-secondary);
...
function GoToTopButton() {
  ...
  }, []), /* @__PURE__ */ import_react99.default.createElement(Button5, {
    id: "go-to-top-button",
    display: show,
    onClick: () => {
      window.scrollTo({
...
var loader11 = async ({ request }) => {
  ...
  let user = await getAuthenticatedUser(request), url = new URL(request.url), order2 = url.searchParams.get("order"), status = url.searchParams.get("status"), department = Number.parseInt(url.searchParams.get("department"), 10), location = url.searchParams.get("location"), dateRange = dateRangeConversion_default(url.searchParams.get("dateRange")), page = url.searchParams.get("page") ?? 1, questionsFAQ = await list_default({
    ...
    dateRange,
    offset: (page - 1) * PAGE_QUESTIONS_LIMIT
  }), a = allAnswers(questions), locations = await list_default3(), departments = await list_default5();
...
function Index() {
  let { questions: initialQuestions } = (0, import_react107.useLoaderData)(), { questionsFAQ: popularQuestions } = (0, import_react107.useLoaderData)(), [questions, setQuestions] = (0, import_react108.useState)(initialQuestions), [questionsFAQ, setFAQ] = (0, import_react108.useState)(popularQuestions), fetcher = (0, import_react107.useFetcher)(), [shouldFetch, setShouldFetch] = (0, import_react108.useState)(!0), [page, setPage] = (0, import_react108.useState)(2), [searchParams] = (0, import_react107.useSearchParams)(), onFetchMore = () => {
  ...
  return (0, import_react108.useEffect)(() => {
    ...
    setQuestions(initialQuestions), setFAQ(popularQuestions), setPage(2), setShouldFetch(!0);
...
init_react();
var assets_manifest_default = { version: "1b635ed5", entry: { module: "/build/entry.client-QZSEPLR5.js", imports: ["/build/_shared/chunk-VMH7LORY.js", "/build/_shared/chunk-3MAIR26M.js", "/build/_shared/chunk-4DA2OAD7.js"] }, routes: { root: { id: "root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/root-4LFB3UVN.js", imports: ["/build/_shared/chunk-2FRVHCAR.js", "/build/_shared/chunk-CHRNTAPK.js", "/build/_shared/chunk-MCBQ4NGY.js", "/build/_shared/chunk-IBDLLEVI.js", "/build/_shared/chunk-2ATFA6QJ.js", "/build/_shared/chunk-G65RIFQG.js", "/build/_shared/chunk-HW6BGKIM.js", "/build/_shared/chunk-QSZDZ2CR.js", "/build/_shared/chunk-EH6OGSNW.js", "/build/_shared/chunk-CP2RARZH.js", "/build/_shared/chunk-Q745UF6A.js", "/build/_shared/chunk-EDO2VLX7.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !0 }, "routes/$": { id: "routes/$", parentId: "root", path: "*", index: void 0, caseSensitive: void 0, module: "/build/routes/$-NQSOQPOY.js", imports: ["/build/_shared/chunk-NGVCGJMJ.js"], hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/about": { id: "routes/about", parentId: "root", path: "about", index: void 0, caseSensitive: void 0, module: "/build/routes/about-ZHIKENI6.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/admin": { id: "routes/admin", parentId: "root", path: "admin", index: void 0, caseSensitive: void 0, module: "/build/routes/admin-NY6MMD6V.js", imports: ["/build/_shared/chunk-NGVCGJMJ.js", "/build/_shared/chunk-2DZ3Y6FQ.js", "/build/_shared/chunk-GHYRS774.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !0, hasErrorBoundary: !1 }, "routes/auth/auth0": { id: "routes/auth/auth0", parentId: "root", path: "auth/auth0", index: void 0, caseSensitive: void 0, module: "/build/routes/auth/auth0-BMP7H4G5.js", imports: void 0, hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/auth/auth0/callback": { id: "routes/auth/auth0/callback", parentId: "routes/auth/auth0", path: "callback", index: void 0, caseSensitive: void 0, module: "/build/routes/auth/auth0/callback-UP5PDGOP.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/contact": { id: "routes/contact", parentId: "root", path: "contact", index: void 0, caseSensitive: void 0, module: "/build/routes/contact-ZXXDXHH6.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/employees/getByDeparment/$id": { id: "routes/employees/getByDeparment/$id", parentId: "root", path: "employees/getByDeparment/:id", index: void 0, caseSensitive: void 0, module: "/build/routes/employees/getByDeparment/$id-LDHH4SEH.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/example": { id: "routes/example", parentId: "root", path: "example", index: void 0, caseSensitive: void 0, module: "/build/routes/example-NX35JNTW.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/index": { id: "routes/index", parentId: "root", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/index-RMPW4A33.js", imports: ["/build/_shared/chunk-QIZSXKRG.js", "/build/_shared/chunk-X7Z6ZX7J.js", "/build/_shared/chunk-D3E4TBWT.js", "/build/_shared/chunk-AGULABHZ.js", "/build/_shared/chunk-GHYRS774.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/login": { id: "routes/login", parentId: "root", path: "login", index: void 0, caseSensitive: void 0, module: "/build/routes/login-PQLX2GUW.js", imports: ["/build/_shared/chunk-QIZSXKRG.js", "/build/_shared/chunk-D3E4TBWT.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/logout": { id: "routes/logout", parentId: "root", path: "logout", index: void 0, caseSensitive: void 0, module: "/build/routes/logout-TUTJ4EAW.js", imports: void 0, hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/questions/$questionId": { id: "routes/questions/$questionId", parentId: "root", path: "questions/:questionId", index: void 0, caseSensitive: void 0, module: "/build/routes/questions/$questionId-EXHTNY42.js", imports: ["/build/_shared/chunk-2DZ3Y6FQ.js", "/build/_shared/chunk-X7Z6ZX7J.js", "/build/_shared/chunk-UUAKVUHR.js", "/build/_shared/chunk-AGULABHZ.js", "/build/_shared/chunk-GHYRS774.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/questions/new": { id: "routes/questions/new", parentId: "root", path: "questions/new", index: void 0, caseSensitive: void 0, module: "/build/routes/questions/new-TEVUP37M.js", imports: ["/build/_shared/chunk-D3E4TBWT.js", "/build/_shared/chunk-UUAKVUHR.js", "/build/_shared/chunk-AGULABHZ.js", "/build/_shared/chunk-GHYRS774.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 } }, url: "/build/manifest-1B635ED5.js" };
