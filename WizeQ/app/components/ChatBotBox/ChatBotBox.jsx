import * as Styled from 'app/components/ChatBotBox/ChatBotBox.Styled';
import React, { useEffect, useRef, useState } from 'react';
import iconUser from 'app/images/placeholder_user_img.png';

function ChatBotBox(visible) {
