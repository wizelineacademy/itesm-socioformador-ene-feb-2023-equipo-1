	...
	return (
		<Styled.About>
			<Styled.AboutBody>
				...
				<p>
					<strong>Wizeline Questions (WizeQ)</strong> is a communication space
					where you can express your ideas, learn more about Wizeline, and ask
				...
				<Styled.BoxWrapper>
					<Styled.BoxContainer>
						...
						<Styled.BoxMetadata>
							...
							same question. If that is not the case, this is your chance to
							shine!
						</Styled.BoxMetadata>
					</Styled.BoxContainer>
					<Styled.BoxContainer>
				...
				<Styled.AboutMetadata>
					<p>
						...
						posts on Slack. Do you need information to persist?{" "}
						<strong>Use Wizeline Questions instead!</strong>
					</p>
				</Styled.AboutMetadata>
				<h3>What else?</h3>
				<Styled.AboutWhatElseContainer>
					<Styled.AboutWHatElseText>
						...
						<Styled.AboutWhatElseMetadata>
							...
							discussion forum, suggestion what-else, or simply visit to say
							hello! Help us to keep Wizeline an amazing place!
						</Styled.AboutWhatElseMetadata>
					</Styled.AboutWHatElseText>
				</Styled.AboutWhatElseContainer>
				<Styled.AboutWhatElseContainer>
					<Styled.AboutWHatElseText>
						...
						<Styled.AboutWhatElseMetadata>
							Ask on Wizeline Questions! To promote ownership and open
			...
			<Styled.AboutFooter>
				<p>
					<strong>We need your help!</strong> Wizeline Questions is an internal
					project and everyone can contribute. Come aboard and meet the team at
					<a
					...
					<a href="https://github.com/wizeline/wize-q-remix">source code</a> on
					GitHub.
				</p>
			</Styled.AboutFooter>
		</Styled.About>
