...
function BsFillPinAngleFill(props) {
...
function BsArrowDownCircle(props) {
...
function BsArrowUpCircle(props) {
...
`;
var Slider = styled_components_browser_esm_default.span`
position: absolute;
cursor: pointer;
top: 0;
left: 0;
...
function Switch2({ id, checked, onChange }) {
  return /* @__PURE__ */ import_react.default.createElement(Switch, {
  ...
  }), /* @__PURE__ */ import_react.default.createElement(Slider, null));
}
...
//# sourceMappingURL=/build/_shared/chunk-AGULABHZ.js.map
